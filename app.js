                    ...
                    React.createElement("div", { style: { marginBottom: 10 } },
                        ...
                        React.createElement("div", { style: { display: "flex", gap: 6, flexWrap: "wrap", marginBottom: 6 } },
                            ...
                            React.createElement("span", { style: { background: thH + prH > t.maxH ? "#FEE2E2" : "#FEF3C7",
                                ...
                                t.maxH,
                                "\u0633"),
                            cells.some(c => c.isSharedCopy) && (React.createElement("span", { style: { background: "#F5F3FF", color: "#6D28D9", borderRadius: 5, padding: "3px 8px", fontSize: 10, fontWeight: 700 } },
                                "\uD83D\uDD17 ",
                        ...
                        React.createElement("div", { style: { display: "flex", gap: 5, flexWrap: "wrap" } }, specGroups.map(({ sp, cells: sc }) => (React.createElement("span", { key: sp.id, style: { background: sp.color + "18", color: sp.color,
                                border: `1px solid ${sp.color}44`, borderRadius: 5, padding: "2px 8px", fontSize: 10, fontWeight: 700 } },
                            sp.name,
                            ": ",
                            sc.length,
                            " \u062D\u0635\u0629"))))),
                    React.createElement(GridTable, { cells: cells, color: "#0C4A6E", showSpec: true })));
            }),
