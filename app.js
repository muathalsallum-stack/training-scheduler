...
function SchedCell({ cell, courses, trainers, halls, spColor, mainSpec, onRemove, onUpdate, sched, periods, conflicts, sharedWith, allGroups, onAddShared }) {
    ...
    return (React.createElement("div", { draggable: true, onDragStart: e => e.dataTransfer.setData("moveCell", JSON.stringify({ id: cell.id, day: cell.day, period: cell.period })), style: { background: hasConflict ? "#FEF2F2" : color + "11",
        ...
        (isTheory || (hasBoth && sessionType === "theory")) && (React.createElement("div", { style: { marginBottom: 3 } },
            ...
            React.createElement("select", { value: cell.theoryTrainerId || "", onChange: e => onUpdate({ theoryTrainerId: e.target.value || null }), style: { width: "100%", background: "#E0FDF9", border: "1px solid #A5F3FC", borderRadius: 4,
...
function App() {
    ...
    const checkTrainerConflict = (trainerId, day, period, excludeId = null) => {
        ...
        const currentSourceId = (currentCell === null || currentCell === void 0 ? void 0 : currentCell.sourceId) || ((currentCell === null || currentCell === void 0 ? void 0 : currentCell.isSharedCopy) ? null : currentCell === null || currentCell === void 0 ? void 0 : currentCell.id);
        const conflict = all.find(c => {
            ...
            if (currentSourceId && cSourceId && currentSourceId === cSourceId)
                return false;
            return true;
        });
        if (!conflict)
        ...
        return (React.createElement("div", null,
            React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 18 } },
                ...
                React.createElement(Btn, { onClick: () => {
                        ...
                        a.click();
                    }, bg: "#0E7490", outline: true, sm: true }, "\u2B07\uFE0F \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0642\u0627\u0644\u0628"),
            ...
            modal === "importTrainersExcel" && (React.createElement(Modal, { title: "\uD83D\uDCCA \u0627\u0633\u062A\u064A\u0631\u0627\u062F \u0627\u0644\u0645\u062F\u0631\u0628\u064A\u0646 \u0645\u0646 Excel", onClose: () => setModal(null), wide: true },
                ...
                React.createElement("div", { style: { marginBottom: 14 } },
                    React.createElement("div", { style: { color: "#0F766E", fontSize: 11, marginBottom: 6, fontWeight: 700 } }, "\u0623\u0648 \u0627\u0644\u0635\u0642 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u0646 Excel \u0645\u0628\u0627\u0634\u0631\u0629 (Ctrl+C \u062B\u0645 Ctrl+V):"),
                    React.createElement("textarea", { id: "trainer-csv-input", rows: 5, placeholder: "أ. محمد العمري\t1001\tبكالوريوس\tnet\tgen\t\t18\t\tالأحد\t\nأ. سارة الزهراني\t1002\tماجستير\tauto\tgen\t\t16", style: { width: "100%", background: "#F0FDFA", border: "1px solid #A5F3FC", borderRadius: 8,
    ...
    const HallsTab = () => {
        ...
        return (React.createElement("div", null,
            ...
            modal === "importHalls" && (React.createElement(Modal, { title: "\uD83D\uDCCA \u0627\u0633\u062A\u064A\u0631\u0627\u062F \u0627\u0644\u0642\u0627\u0639\u0627\u062A \u0645\u0646 Excel", onClose: () => setModal(null) },
                React.createElement("div", { style: { color: "#0C4A6E", fontSize: 11, lineHeight: 1.9, marginBottom: 12,
                ...
                React.createElement("div", { style: { marginBottom: 10 } },
                    React.createElement("div", { style: { color: "#0C4A6E", fontSize: 11, fontWeight: 700, marginBottom: 4 } }, "\u0627\u0644\u0635\u0642 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0647\u0646\u0627:"),
                    React.createElement("textarea", { id: "halls-paste", rows: 7, placeholder: "قاعة 101\t101\ttheory\t30\tall\nمختبر شبكات 1\tN101\tpractical\t20\tnet\nورشة محركات 1\tA101\tpractical\t20\tauto", style: { width: "100%", border: "1px solid #A5F3FC", borderRadius: 8, padding: 10,
                                        ...
                                        const cellConflicts = cell ? (() => {
                                            ...
                                            [cell.theoryTrainerId, cell.practicalTrainerId].filter(Boolean).forEach(tid => {
                                                ...
                                                const clash = all.find(x => {
                                                    if (x.id === cell.id)
                                                        return false;
                                                    if (x.day !== day || x.period !== pr.id)
                                                        return false;
                                                    if (x.theoryTrainerId !== tid && x.practicalTrainerId !== tid)
                                                        return false;
                                                    // Skip same sharing family
                                                    const xFam = x.sourceId || (x.isSharedCopy ? null : x.id);
                                                    if (familyId && xFam && familyId === xFam)
                                                        return false;
                                                    return true;
                                                });
                                                if (clash) {
        ...
        return (React.createElement("div", { id: "print-area" },
                        ...
                        return (React.createElement("div", { key: g.id, style: { marginBottom: 14 } },
                            React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 7 } },
                                ...
                                (() => {
                                    ...
                                    return (React.createElement(React.Fragment, null,
                                        th > 0 && React.createElement("span", { style: { background: "#EFF6FF", color: "#0E7490", borderRadius: 5, padding: "1px 8px", fontSize: 10, fontWeight: 700 } },
                                            "\uD83D\uDCD8 \u0646\u0638\u0631\u064A: ",
                                            th),
                                        pr > 0 && React.createElement("span", { style: { background: "#ECFDF5", color: "#065F46", borderRadius: 5, padding: "1px 8px", fontSize: 10, fontWeight: 700 } },
                                            "\uD83D\uDD27 \u0639\u0645\u0644\u064A: ",
                                            pr)));
                                })()),
            ...
            viewMode === "trainers" && trainers.map(t => {
                ...
                return (React.createElement("div", { key: t.id, style: { background: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: 13, padding: 14, marginBottom: 14 } },
                    React.createElement("div", { style: { marginBottom: 10 } },
                        React.createElement("div", { style: { color: "#042F2E", fontWeight: 800, fontSize: 14, marginBottom: 6 } }, t.name),
                        React.createElement("div", { style: { display: "flex", gap: 6, flexWrap: "wrap" } },
                            React.createElement("span", { style: { background: "#EFF6FF", color: "#0E7490", borderRadius: 6, padding: "3px 10px", fontSize: 10, fontWeight: 700 } },
                                "\uD83D\uDCD8 \u0646\u0638\u0631\u064A: ",
                                thH,
                                "\u0633"),
                            ...
                            React.createElement("span", { style: { background: thH + prH > t.maxH ? "#FEE2E2" : "#FEF3C7",
                                ...
                                t.maxH,
                                "\u0633"),
                            cells.some(c => c.isSharedCopy) && (React.createElement("span", { style: { background: "#F5F3FF", color: "#6D28D9", borderRadius: 5,
            ...
            viewMode === "halls" && halls.map(hall => {
                ...
                return (React.createElement("div", { key: hall.id, style: { background: "#FFFFFF",
                    ...
                    React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 10, flexWrap: "wrap" } },
                        React.createElement("div", { style: { color: "#042F2E", fontWeight: 800, fontSize: 14 } }, hall.name),
                        ...
                        React.createElement("span", { style: { background: "#FEF3C7", color: "#92400E", borderRadius: 5, padding: "2px 8px", fontSize: 10, fontWeight: 700 } },
                            "\uD83D\uDC65 \u0633\u0639\u0629: ",
                            hall.cap,
                            " \u0645\u062A\u062F\u0631\u0628"),
                        React.createElement("span", { style: { background: "#F0FDF9", color: "#0C4A6E", borderRadius: 5, padding: "2px 8px", fontSize: 10, fontWeight: 700 } },
                            hc.length,
                            " \u062D\u0635\u0629 \u0645\u062D\u062C\u0648\u0632\u0629"),
                        thCount > 0 && React.createElement("span", { style: { background: "#EFF6FF", color: "#0E7490", borderRadius: 5, padding: "2px 8px", fontSize: 10 } },
                            "\uD83D\uDCD8 ",
                            thCount,
                            " \u0646\u0638\u0631\u064A"),
                        prCount > 0 && React.createElement("span", { style: { background: "#ECFDF5", color: "#065F46", borderRadius: 5, padding: "2px 8px", fontSize: 10 } },
                            "\uD83D\uDD27 ",
                            prCount,
                            " \u0639\u0645\u0644\u064A")),
      ...
      ` } }),
            React.createElement("div", { style: { background: "linear-gradient(135deg,#0C4A6E,#0E7490)", padding: "10px 16px",
                ...
                React.createElement("div", { style: { display: "flex", gap: 8, flexShrink: 0, alignItems: "center" } },
                    React.createElement("span", { style: { color: "#A5F3FC", fontSize: 9, display: "flex", alignItems: "center", gap: 3 } },
                        "\uD83D\uDCBE ",
