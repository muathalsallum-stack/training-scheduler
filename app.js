...
function SchedCell({ cell, courses, trainers, halls, spColor, mainSpec, onRemove, onUpdate, sched, periods, conflicts, sharedWith, allGroups, onAddShared }) {
    ...
    return (React.createElement("div", { draggable: true, onDragStart: e => e.dataTransfer.setData("moveCell", JSON.stringify({ id: cell.id, day: cell.day, period: cell.period })), style: { background: hasConflict ? "#FEF2F2" : color + "11",
        ...
        React.createElement("div", { style: { marginBottom: 4 } },
            React.createElement("input", { value: cell.refNumber || "", onChange: e => onUpdate({ refNumber: e.target.value }), placeholder: "\u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u0645\u0631\u062C\u0639\u064A...", onClick: e => e.stopPropagation(), onMouseDown: e => e.stopPropagation(), style: { width: "100%", background: "#F0FDFA", border: "1px solid #CBD5E1", borderRadius: 8,
        ...
        hasBoth && (React.createElement("div", { style: { display: "flex", gap: 3, marginBottom: 4 } }, ["theory", "practical"].map(t => (React.createElement("button", { key: t, onClick: () => onUpdate({ sessionType: t }), style: { flex: 1,
                background: sessionType === t ? (t === "theory" ? "#E0FDF9" : "#ECFDF5") : "#F0FDFA",
        ...
        React.createElement("div", { style: { marginBottom: 4 } },
            ...
            React.createElement("div", { style: { display: "flex", gap: 3 } }, [1, 2, 3, 4].map(h => (React.createElement("button", { key: h, onClick: () => onUpdate({ sessionHours: h }), disabled: h > maxH, style: { flex: 1,
                    ...
                    border: `1px solid ${sessionH === h ? color : h > maxH ? "#A5F3FC" : "#0D9488"}`,
...
function PeriodSettingsModal({ periods, setPeriods, onClose }) {
    ...
    return (React.createElement(Modal, { title: "\u2699\uFE0F \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0623\u0648\u0642\u0627\u062A \u0627\u0644\u062D\u0635\u0635", onClose: onClose, wide: true },
                ...
                React.createElement("tbody", null, local.map((p, i) => (React.createElement(React.Fragment, null,
                    React.createElement("tr", { key: p.id, style: { background: i % 2 === 0 ? "#0C4A6E" : "#FFFFFF" } },
                        ...
                        React.createElement("td", { style: { padding: "6px 8px", border: "1px solid #1e2d45", textAlign: "center" } },
                            React.createElement("button", { onClick: () => toggleBreak(i), style: { background: p.breakAfter ? "#065F46" : "#FFFFFF", border: `1px solid ${p.breakAfter ? "#10b981" : "#A5F3FC"}`,
        ...
        React.createElement("div", { style: { display: "flex", gap: 10, marginTop: 16 } },
            ...
            React.createElement(Btn, { onClick: () => { setLocal(DEFAULT_PERIOD_CONFIG.map(p => (Object.assign(Object.assign({}, p), { breakAfter: p.breakAfter ? Object.assign({}, p.breakAfter) : null })))); }, bg: "#A5F3FC", outline: true }, "\u21BA \u0625\u0639\u0627\u062F\u0629 \u0627\u0644\u0636\u0628\u0637"))));
}
// ══════════════════════════════════════════════════════════════
...
function CourseAssignModal({ courses, trainers, assignments, setAssignments, onClose }) {
    ...
    return (React.createElement(Modal, { title: "\uD83D\uDCCB \u062A\u062E\u0635\u064A\u0635 \u0627\u0644\u0645\u062F\u0631\u0628\u064A\u0646 \u0644\u0644\u0645\u0642\u0631\u0631\u0627\u062A", onClose: onClose, wide: true },
        React.createElement("div", { style: { background: "#FFFFFF", borderRadius: 12, padding: 10, marginBottom: 14, fontSize: 11, color: "#0F766E", lineHeight: 1.8 } }, "\u0647\u0646\u0627 \u064A\u0645\u0643\u0646\u0643 \u062A\u062E\u0635\u064A\u0635 \u0645\u062F\u0631\u0628 \u062B\u0627\u0628\u062A \u0644\u0643\u0644 \u0645\u0642\u0631\u0631 (\u0646\u0638\u0631\u064A \u0648/\u0623\u0648 \u0639\u0645\u0644\u064A). \u0639\u0646\u062F \u0648\u0636\u0639 \u0627\u0644\u0645\u0642\u0631\u0631 \u0641\u064A \u0627\u0644\u062C\u062F\u0648\u0644\u060C \u0633\u064A\u064F\u0639\u0628\u0623 \u0627\u0644\u0645\u062F\u0631\u0628 \u062A\u0644\u0642\u0627\u0626\u064A\u0627\u064B. \u064A\u0645\u0643\u0646 \u0623\u0646 \u064A\u0643\u0648\u0646 \u0645\u062F\u0631\u0628 \u0627\u0644\u0646\u0638\u0631\u064A \u0645\u062E\u062A\u0644\u0641\u0627\u064B \u0639\u0646 \u0645\u062F\u0631\u0628 \u0627\u0644\u0639\u0645\u0644\u064A."),
        React.createElement("div", { style: { display: "flex", gap: 8, marginBottom: 14, flexWrap: "wrap" } }, [{ id: "all", name: "الكل", color: "#0F766E" }, ...SPECIALIZATIONS].map(s => (React.createElement("button", { key: s.id, onClick: () => setFilterSpec(s.id), style: { padding: "5px 12px", borderRadius: 10, border: `1px solid ${s.color}55`,
                ...
                React.createElement("tbody", null, vis.map(c => {
                    ...
                    return (React.createElement("tr", { key: c.id, style: { borderBottom: "1px solid #1a2535" } },
                        ...
                        React.createElement("td", { style: { padding: "6px 8px", border: "1px solid #1a2535" } }, (!isPract) ? (React.createElement("select", { value: a.theoryId || "", onChange: e => setAssign(c.id, "theoryId", e.target.value || null), style: { width: "100%", background: "#FFFFFF", border: "1px solid #1e40af", borderRadius: 6,
                            ...
                            avTr.map(t => React.createElement("option", { key: t.id, value: t.id }, t.name)))) : React.createElement("span", { style: { color: "#A5F3FC", fontSize: 10 } }, "\u0644\u0627 \u064A\u0648\u062C\u062F \u0646\u0638\u0631\u064A")),
                        React.createElement("td", { style: { padding: "6px 8px", border: "1px solid #1a2535" } }, c.P > 0 ? (React.createElement("select", { value: a.practicalId || "", onChange: e => setAssign(c.id, "practicalId", e.target.value || null), style: { width: "100%", background: "#FFFFFF", border: "1px solid #064e3b", borderRadius: 6,
                            ...
                            React.createElement("option", { value: "" }, "-- \u063A\u064A\u0631 \u0645\u062D\u062F\u062F --"),
                            avTr.map(t => React.createElement("option", { key: t.id, value: t.id }, t.name)))) : React.createElement("span", { style: { color: "#A5F3FC", fontSize: 10 } }, "\u0644\u0627 \u064A\u0648\u062C\u062F \u0639\u0645\u0644\u064A"))));
                })))),
...
function App() {
    ...
    // Print filter: "all" or specific id (trainerId / groupKey / hallId)
    const [printFilter, setPrintFilter] = (0, React.useState)("all");
    ...
    const addSharedCopies = (cell, fromSpec, fromLv, fromGid, keys) => {
        ...
        let addedCount = 0;
        const warnings = [];
        // Build the entire update in ONE atomic setScheds call to avoid race conditions
        setScheds(prev => {
            const next = JSON.parse(JSON.stringify(prev));
            // Tag source cell
            if (next[fromSpec] && next[fromSpec][fromLv] && next[fromSpec][fromLv][fromGid]) {
                next[fromSpec][fromLv][fromGid] = next[fromSpec][fromLv][fromGid].map(s => s.id === cell.id ? Object.assign(Object.assign({}, s), { sourceId: cell.id, sharedGroupKeys: [], showSharing: false }) : s);
            }
            keys.forEach(key => {
                const [sp, lv, gid] = key.split('-');
                const lvN = +lv;
                const grps = (groups[sp] && groups[sp][lvN]) || [];
                ...
                if (!next[sp][lvN][gid])
                    next[sp][lvN][gid] = [];
                const targetCells = next[sp][lvN][gid];
                // ── Check slot not occupied (using the up-to-date `next` state) ──
                if (targetCells.find(s => s.day === cell.day && s.period === cell.period)) {
                    warnings.push(`❌ ${label}: الخانة مشغولة بمقرر آخر — تم التخطي`);
                    return;
                }
                // ── Conflict warnings (informational only) ──
                ...
                if (hasBoth) {
                    targetCells.push(Object.assign(Object.assign({}, baseCell), { id: uid(), sessionType: "theory", sessionHours: course.L + course.T, practicalTrainerId: null }));
                    targetCells.push(Object.assign(Object.assign({}, baseCell), { id: uid(), sessionType: "practical", sessionHours: course.P, theoryTrainerId: null }));
                }
                else {
                    targetCells.push(Object.assign(Object.assign({}, baseCell), { id: uid() }));
                }
                addedCount++;
            });
            return next;
    ...
    const Dashboard = () => {
        ...
        return (React.createElement("div", null,
                ...
                React.createElement("div", { style: { marginBottom: 10 } },
                    ...
                    React.createElement("div", { style: { display: "flex", gap: 8 } },
                        React.createElement("input", { value: collegeName, onChange: e => {
                                ...
                                borderRadius: 16, padding: "10px 14px", fontSize: 14, color: "#042F2E",
            ...
            adminView && (React.createElement("div", { style: { background: "#0C4A6E", borderRadius: 20, padding: 16, marginBottom: 16 } },
            ...
            React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr", gap: 12, marginBottom: 20 } },
                React.createElement("div", { style: { background: "#FFFFFF", border: "2px solid #0E7490", borderRadius: 14, padding: 16 } },
                    React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" } },
                        React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10 } },
                            React.createElement("div", { style: { width: 40, height: 40, background: "#E0FDF9", borderRadius: 16,
                    ...
                    showPlanImport && (React.createElement("div", { style: { marginTop: 14, padding: "14px", background: "#F0FDFA", borderRadius: 16 } },
            ...
            React.createElement("div", { style: { background: "#FFFFFF", border: "1px solid #A5F3FC", borderRadius: 20, padding: 16, marginBottom: 16 } },
                ...
                React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 6 } }, periods.map(p => (React.createElement("div", { key: p.id, style: { background: "#E0FDF9", border: "1px solid #A5F3FC", borderRadius: 12, padding: "6px 12px", textAlign: "center", minWidth: 90 } },
    ...
    const CoursesTab = () => {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement("div", { style: { display: "flex", gap: 8, marginBottom: 16, flexWrap: "wrap" } },
                [{ id: "all", name: "الكل", color: "#0F766E" }, ...SPECIALIZATIONS].map(s => (React.createElement("button", { key: s.id, onClick: () => setFs(s.id), style: { padding: "5px 12px", borderRadius: 12, border: `1px solid ${s.color}55`,
                ...
                React.createElement("div", { style: { marginRight: "auto", display: "flex", gap: 5 } }, [{ v: 0, l: "الكل" }, ...[1, 2, 3, 4, 5].map(x => ({ v: x, l: "فصل " + x }))].map(o => (React.createElement("button", { key: o.v, onClick: () => setFl(o.v), style: { padding: "5px 11px", borderRadius: 12, border: "1px solid #2a3a55",
                        background: fl === o.v ? "#A5F3FC" : "transparent", color: fl === o.v ? "#134E4A" : "#0F766E", cursor: "pointer", fontSize: 12 } }, o.l))))),
            React.createElement("div", { style: { overflowX: "auto", background: "#FFFFFF", border: "1px solid #1e2d45", borderRadius: 20 } },
                React.createElement("table", { style: { borderCollapse: "collapse", width: "100%", fontSize: 12 } },
                    ...
                    React.createElement("tbody", null, vis.map(c => {
                        ...
                        return (React.createElement("tr", { key: c.id },
                            ...
                            React.createElement("td", { style: { padding: "7px 10px", border: "1px solid #1a2535" } }, tTr ? React.createElement(Badge, { color: "#3b82f6" }, tTr.name) : React.createElement("span", { style: { color: "#A5F3FC", fontSize: 10 } }, "\u2014")),
                            React.createElement("td", { style: { padding: "7px 10px", border: "1px solid #1a2535" } }, pTr ? React.createElement(Badge, { color: "#10b981" }, pTr.name) : React.createElement("span", { style: { color: "#A5F3FC", fontSize: 10 } }, "\u2014")),
                            React.createElement("td", { style: { padding: "7px 10px", textAlign: "center", border: "1px solid #1a2535" } },
                ...
                React.createElement("div", { style: { padding: "8px 14px", color: "#A5F3FC", fontSize: 11 } },
                    vis.length,
                    " \u0645\u0642\u0631\u0631")),
            modal === "addCourse" && (React.createElement(Modal, { title: "\u0625\u0636\u0627\u0641\u0629 \u0645\u0642\u0631\u0631 \u062C\u062F\u064A\u062F", onClose: () => setModal(null) },
                ...
                React.createElement("div", { style: { background: "#FFFFFF", borderRadius: 12, padding: 10, marginBottom: 14, fontSize: 12, color: "#0F766E" } },
    ...
    const TrainersTab = () => {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(260px,1fr))", gap: 14 } }, trainers.map(t => {
                ...
                return (React.createElement("div", { key: t.id, style: { background: "#FFFFFF", border: "1px solid rgba(200,200,210,0.5)", borderRadius: 20, padding: 18 } },
                    ...
                    ((t.offDays || []).length > 0 || (t.offSlots || []).length > 0) && (React.createElement("div", { style: { background: "#FEF3C7", border: "1px solid #F59E0B", borderRadius: 12,
                        ...
                        (t.offSlots || []).map((s, i) => (React.createElement("div", { key: i, style: { color: "#92400E", fontSize: 9, marginTop: 2 } },
                            ...
                            ": \u0627\u0644\u062D\u0635\u0635 ",
                            s.periods.join("، ")))))),
                    React.createElement("div", { style: { background: "#F0FDFA", borderRadius: 8, height: 6, overflow: "hidden", marginBottom: 5 } },
                    ...
                    return (React.createElement("div", { style: { position: "fixed", inset: 0, background: "#00000099", zIndex: 3000,
                        ...
                        React.createElement("div", { style: { background: "#FFFFFF", borderRadius: 24, padding: 24, width: 420,
                            ...
                            React.createElement("div", { style: { display: "flex", gap: 10 } },
                                React.createElement("button", { onClick: save, style: { flex: 1, background: "#0E7490", color: "#fff", border: "none", borderRadius: 16,
                ...
                return (React.createElement("div", { style: { position: "fixed", inset: 0, background: "#00000099", zIndex: 3000,
                    ...
                    React.createElement("div", { style: { background: "#FFFFFF", borderRadius: 24, padding: 24, width: 480,
                        ...
                        DAYS.map(day => {
                            ...
                            return (React.createElement("div", { key: day, style: { marginBottom: 12, border: `2px solid ${isFullDay ? "#F59E0B" : "#A5F3FC"}`,
                                    borderRadius: 16, padding: 12, background: isFullDay ? "#FEF9E7" : "#F0FDFA" } },
            ...
            modal === "importTrainersExcel" && (React.createElement(Modal, { title: "\uD83D\uDCCA \u0627\u0633\u062A\u064A\u0631\u0627\u062F \u0627\u0644\u0645\u062F\u0631\u0628\u064A\u0646 \u0645\u0646 Excel", onClose: () => setModal(null), wide: true },
                ...
                React.createElement("div", { style: { marginBottom: 14 } },
                    ...
                    React.createElement("input", { type: "file", accept: ".xlsx,.xls,.csv", onChange: async (e) => {
                            ...
                            borderRadius: 16, padding: "20px", color: "#0F766E", fontSize: 12, cursor: "pointer", boxSizing: "border-box" } })),
                React.createElement("div", { style: { marginBottom: 14 } },
                    ...
                    React.createElement("textarea", { id: "trainer-csv-input", rows: 5, placeholder: "أ. محمد العمري\t1001\tبكالوريوس\tnet\tgen\t\t18\t\tالأحد\t\nأ. سارة الزهراني\t1002\tماجستير\tauto\tgen\t\t16", style: { width: "100%", background: "#F0FDFA", border: "1px solid #A5F3FC", borderRadius: 12,
        ...
        return (React.createElement("div", null,
            ...
            modal === "importHalls" && (React.createElement(Modal, { title: "\uD83D\uDCCA \u0627\u0633\u062A\u064A\u0631\u0627\u062F \u0627\u0644\u0642\u0627\u0639\u0627\u062A \u0645\u0646 Excel", onClose: () => setModal(null) },
                React.createElement("div", { style: { color: "#0C4A6E", fontSize: 11, lineHeight: 1.9, marginBottom: 12,
                        background: "#E0FDF9", border: "1px solid #A5F3FC", borderRadius: 12, padding: "10px 14px" } },
    ...
    const TraineesTab = () => {
        ...
        return (React.createElement("div", null,
            React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 18 } },
                ...
                React.createElement("div", { style: { display: "flex", gap: 8 } },
                    React.createElement(Btn, { onClick: () => setModal("import"), bg: "#A5F3FC", outline: true, sm: true }, "\uD83D\uDCE5 \u0627\u0633\u062A\u064A\u0631\u0627\u062F CSV"),
            ...
            React.createElement("div", { style: { display: "flex", gap: 8, marginBottom: 14, flexWrap: "wrap" } },
                ...
                React.createElement("div", { style: { marginRight: "auto", display: "flex", gap: 5 } }, [1, 2, 3, 4, 5].map(l => (React.createElement("button", { key: l, onClick: () => setLl(l), style: { padding: "6px 12px", borderRadius: 12, border: "1px solid #2a3a55",
                        background: ll === l ? "#A5F3FC" : "transparent", color: ll === l ? "#134E4A" : "#0F766E", cursor: "pointer", fontSize: 12 } },
                    "\u0645",
                    l))))),
            ...
            filt.length === 0
                ? React.createElement("div", { style: { textAlign: "center", padding: 40, border: "1px dashed #1e2d45", borderRadius: 16, color: "#A5F3FC" } }, "\u0644\u0627 \u064A\u0648\u062C\u062F \u0645\u062A\u062F\u0631\u0628\u0648\u0646")
            ...
            modal === "import" && (React.createElement(Modal, { title: "\u0627\u0633\u062A\u064A\u0631\u0627\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u062A\u062F\u0631\u0628\u064A\u0646", onClose: () => setModal(null), wide: true },
                React.createElement("div", { style: { background: "#FFFFFF", borderRadius: 12, padding: 11, marginBottom: 11, fontSize: 10, color: "#0F766E", fontFamily: "monospace", lineHeight: 1.9 } },
    ...
    const ScheduleTab = () => {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement("div", { style: { display: "flex", gap: 10, marginBottom: 14, alignItems: "center", flexWrap: "wrap" } },
                ...
                React.createElement(Btn, { onClick: () => setModal("periodSettings"), bg: "#A5F3FC", outline: true, sm: true }, "\u2699\uFE0F \u0623\u0648\u0642\u0627\u062A \u0627\u0644\u062D\u0635\u0635"),
                ...
                React.createElement("div", { style: { display: "flex", gap: 5 } }, [1, 2, 3, 4, 5].map(l => (React.createElement("button", { key: l, onClick: () => { setSelLv(l); setSelGroup(null); }, style: { padding: "6px 12px", borderRadius: 12, border: "1px solid #2a3a55",
                        background: selLv === l ? "#A5F3FC" : "transparent", color: selLv === l ? "#134E4A" : "#0F766E", cursor: "pointer", fontSize: 12 } },
                    "\u0645",
                    l))))),
            React.createElement("div", { style: { background: "#FFFFFF", border: "1px solid #1e2d45", borderRadius: 16, padding: "10px 14px", marginBottom: 14 } },
                ...
                curGid && coursesInLevel.length > 0 && (() => {
                    ...
                    if (issues.every(x => !x.hasAny))
                        return null;
                    return (React.createElement("div", { style: { marginTop: 8, background: "#F0FDFA", border: "1px solid #E2E8F0", borderRadius: 16, padding: "10px 14px" } },
            ...
            gs.length === 0 && (React.createElement("div", { style: { textAlign: "center", padding: "40px 20px", border: "1px dashed #1e2d45", borderRadius: 16, color: "#A5F3FC", marginBottom: 14 } },
            ...
            curGid && (React.createElement("div", { style: { display: "grid", gridTemplateColumns: "200px 1fr", gap: 14 } },
                React.createElement("div", { style: { background: "#F0FDFA", border: "1px solid rgba(200,200,210,0.5)", borderRadius: 20, padding: 10, maxHeight: 720, overflowY: "auto" } },
                        ...
                        : coursesInLevel.map(c => {
                            ...
                            return (React.createElement("div", { key: c.id, draggable: true, onDragStart: e => e.dataTransfer.setData("courseId", c.id), style: { background: anyOver ? "#FEF2F2" : allDone ? "#F0FDF4" : cc + "12",
                                ...
                                React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" } },
                                    ...
                                    React.createElement("span", { style: { background: anyOver ? "#EF4444" : allDone ? "#10B981" : "#A5F3FC",
                                ...
                                theoryNeeded > 0 && (React.createElement("div", { style: { marginBottom: 3 } },
                                    React.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: 1 } },
                                        ...
                                        React.createElement("span", { style: { fontSize: 8, color: theoryOver ? "#EF4444" : theoryDone ? "#10B981" : "#0F766E", fontWeight: 700 } },
                                            ...
                                            theoryNeeded,
                                            "\u0633")),
                                    React.createElement("div", { style: { background: "#A5F3FC", borderRadius: 3, height: 5, overflow: "hidden" } },
                    ...
                    React.createElement("div", { style: { marginTop: 10, padding: 8, background: "#E0FDF9", border: "1px solid #BFDBFE", borderRadius: 12, fontSize: 10, color: "#1E40AF", lineHeight: 2 } },
                ...
                React.createElement("div", { style: { overflowX: "auto" } },
                    React.createElement("div", { style: { background: "#FFFFFF", border: `1px solid ${col}55`, borderRadius: 20, padding: 10 } },
                        React.createElement("div", { style: { color: "#0F766E", fontSize: 12, fontWeight: 700, marginBottom: 8 } },
                            ...
                            React.createElement("span", { style: { color: "#A5F3FC", marginRight: 8 } },
                                "(",
                                sched.length,
                                " \u062D\u0635\u0629)")),
                            ...
                            React.createElement("tbody", null, (() => {
                                ...
                                return periods.map(pr => {
                                    const rowCells = DAYS.map(day => {
                                        ...
                                        const borderCol = cellConflicts.length ? "#EF4444" : cell ? (isTheoryCell ? "#A5F3FC" : "#6EE7B7") : "#A5F3FC";
                                        const bgCol = cellConflicts.length ? "#FEF2F2" : cell ? (isTheoryCell ? "#E0FDF9" : "#F0FDF4") : "#F0FDFA";
    ...
    const StatsTab = () => {
        ...
        // ── Progress bar ──────────────────────────────────────────
        const ProgressBar = ({ value, max, color, height = 8 }) => (React.createElement("div", { style: { background: "#A5F3FC", borderRadius: 149, height, overflow: "hidden" } },
        ...
        const StatusBadge = ({ done, over, partial, empty }) => {
            ...
            return React.createElement("span", { style: { background: "#F0FDFA", color: "#0F766E", borderRadius: 8, padding: "2px 8px", fontSize: 10, fontWeight: 700 } }, "\u2B1C \u0644\u0645 \u064A\u064F\u0648\u0632\u064E\u0651\u0639");
        };
        return (React.createElement("div", null,
            React.createElement("div", { style: { display: "flex", gap: 8, marginBottom: 20, flexWrap: "wrap", alignItems: "center" } },
                ...
                [{ id: "all", name: "الكل", color: "#0F766E" }, ...SPECIALIZATIONS.filter(s => !s.shared)].map(s => (React.createElement("button", { key: s.id, onClick: () => setFilterSpec(s.id), style: { padding: "6px 14px", borderRadius: 12, border: `1px solid ${s.color}55`,
            ...
            React.createElement("div", { style: { background: "#FFFFFF", border: "1px solid rgba(200,200,210,0.5)", borderRadius: 20, padding: 18, marginBottom: 20 } },
            ...
            React.createElement("div", { style: { marginBottom: 20 } },
                ...
                stats.map(({ specId, lv, g, courseResults }) => {
                    ...
                    return (React.createElement("div", { key: `${specId}-${lv}-${g.id}`, style: { background: "#FFFFFF", border: `1px solid ${sc}33`, borderRadius: 16, padding: 16, marginBottom: 12 } },
                        ...
                        React.createElement("div", { style: { marginTop: 10, display: "flex", flexWrap: "wrap", gap: 6 } }, courseResults.map(({ c, scheduledTh, scheduledPr, theoryNeeded, practNeeded, done, over, partial, empty }) => (React.createElement("div", { key: c.id, style: {
                                ...
                                border: `1px solid ${over ? "#EF4444" : done ? "#10B981" : partial ? "#F59E0B" : "#A5F3FC"}`,
                ...
                stats.length === 0 && (React.createElement("div", { style: { textAlign: "center", padding: "30px", color: "#0F766E", border: "1px dashed #E2E8F0", borderRadius: 16 } }, "\u0644\u0627 \u062A\u0648\u062C\u062F \u0631\u0632\u0645 \u0628\u0639\u062F \u2014 \u0623\u0636\u0641 \u0631\u0632\u0645\u0629 \u0648\u0627\u0628\u062F\u0623 \u0628\u062A\u0648\u0632\u064A\u0639 \u0627\u0644\u0645\u0642\u0631\u0631\u0627\u062A"))),
            React.createElement("div", { style: { background: "#FFFFFF", border: "1px solid rgba(200,200,210,0.5)", borderRadius: 20, padding: 18, marginBottom: 20 } },
            ...
            React.createElement("div", { style: { background: "linear-gradient(135deg,#1E3A5F,#1D4ED8)", borderRadius: 20, padding: 20, marginBottom: 20 } },
                ...
                React.createElement("div", { style: { marginTop: 16, padding: "10px 14px", background: "#ffffff15", borderRadius: 16, color: "#0C4A6E", fontSize: 12, lineHeight: 2 } }, completePct === 100 && overCourses === 0 && trainerLoad.filter(x => x.over).length === 0
    ...
    const ViewTab = () => {
                ...
                React.createElement("table", { style: { borderCollapse: "collapse", fontSize: 11, width: "100%" } },
                    ...
                    React.createElement("tbody", null, periods.map(pr => {
                        const rowCells = DAYS.map(day => {
                            ...
                            return (React.createElement("td", { key: day, rowSpan: sessionH, style: { border: `3px solid ${crs ? (isTheory ? "#A5F3FC" : "#6EE7B7") : "#A5F3FC"}`,
                                    background: crs ? (isTheory ? "#E0FDF9" : "#ECFDF5") : "#F0FDFA",
                                    padding: "8px 10px", verticalAlign: "top" } }, crs && (React.createElement("div", null,
                                React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 3 } },
                                    React.createElement("span", { style: { background: isTheory ? "#0891B2" : "#10B981", color: "#fff", borderRadius: 8, padding: "2px 7px", fontSize: 9, fontWeight: 700 } }, isTheory ? "📘 نظري" : "🔧 عملي"),
                                    React.createElement("div", { style: { display: "flex", gap: 3 } },
                                        ...
                                        React.createElement("span", { style: { background: isTheory ? "#0E7490" : "#065F46", color: "#fff", borderRadius: 8, padding: "2px 6px", fontSize: 9, fontWeight: 700 } },
                                            sessionH,
                                            "\u0633"))),
        ...
        return (React.createElement("div", { id: "print-area" },
            React.createElement("div", { className: "no-print", style: { display: "flex", gap: 10, marginBottom: 18, alignItems: "center", flexWrap: "wrap" } },
                ...
                React.createElement("div", { style: { display: "flex", gap: 7 } }, [{ id: "trainees", l: "جدول المتدربين", i: "👥" }, { id: "trainers", l: "جدول المدربين", i: "👨‍🏫" }, { id: "halls", l: "جدول القاعات", i: "🏛" }].map(m => (React.createElement("button", { key: m.id, onClick: () => { setViewMode(m.id); setPrintFilter("all"); }, style: { padding: "6px 12px", borderRadius: 12, border: "1px solid #CBD5E1",
                        background: viewMode === m.id ? "#A5F3FC" : "transparent", color: viewMode === m.id ? "#134E4A" : "#0F766E", cursor: "pointer", fontSize: 12 } },
                    m.i,
                    " ",
                    m.l)))),
                viewMode !== "halls" && (React.createElement("div", { style: { display: "flex", gap: 7 } }, SPECIALIZATIONS.filter(s => !s.shared).map(s => (React.createElement("button", { key: s.id, onClick: () => { setViewSpec(s.id); setPrintFilter("all"); }, style: { padding: "6px 12px", borderRadius: 12, border: `1px solid ${s.color}55`,
                        background: viewSpec === s.id ? s.color : "transparent", color: viewSpec === s.id ? "#fff" : s.color, cursor: "pointer", fontSize: 12 } }, s.name))))),
                React.createElement("select", { value: printFilter, onChange: e => setPrintFilter(e.target.value), className: "no-print", style: { padding: "7px 12px", borderRadius: 12, border: "1px solid #A5F3FC",
                        background: "#F0FDFA", color: "#0C4A6E", fontSize: 12, fontWeight: 600, cursor: "pointer" } },
                    React.createElement("option", { value: "all" }, viewMode === "trainers" ? "كل المدربين" : viewMode === "halls" ? "كل القاعات" : "كل الرزم"),
                    viewMode === "trainers" && trainers.map(t => (React.createElement("option", { key: t.id, value: t.id }, t.name))),
                    viewMode === "halls" && halls.map(h => (React.createElement("option", { key: h.id, value: h.id }, h.name))),
                    viewMode === "trainees" && [1, 2, 3, 4, 5].flatMap(lv => (groups[viewSpec] && groups[viewSpec][lv] || []).map(g => (React.createElement("option", { key: `${lv}-${g.id}`, value: `${lv}-${g.id}` },
                        "\u0627\u0644\u0641\u0635\u0644 ",
                        lv,
                        " \u2014 ",
                        g.name))))),
            ...
            viewMode === "trainees" && [1, 2, 3, 4, 5]
                .filter(lv => printFilter === "all" || printFilter.startsWith(`${lv}-`))
                .map(lv => {
                const lvGroups = scheds[viewSpec] && scheds[viewSpec][lv] ? scheds[viewSpec][lv] : {};
                const gs2 = (groups[viewSpec] && groups[viewSpec][lv] || [])
                    .filter(g => printFilter === "all" || printFilter === `${lv}-${g.id}`);
                        ...
                        return (React.createElement("div", { key: g.id, style: { marginBottom: 14 } },
                            React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 7 } },
                                ...
                                (() => {
                                    ...
                                    return (React.createElement(React.Fragment, null,
                                        th > 0 && React.createElement("span", { style: { background: "#EFF6FF", color: "#0E7490", borderRadius: 8, padding: "1px 8px", fontSize: 10, fontWeight: 700 } },
                                            "\uD83D\uDCD8 \u0646\u0638\u0631\u064A: ",
                                            th),
            ...
            viewMode === "trainers" && trainers
                .filter(t => printFilter === "all" || printFilter === t.id)
                .map(t => {
                ...
                return (React.createElement("div", { key: t.id, style: { background: "#FFFFFF", border: "1px solid rgba(200,200,210,0.5)", borderRadius: 20, padding: 14, marginBottom: 14 } },
                    React.createElement("div", { style: { marginBottom: 10 } },
            ...
            viewMode === "halls" && halls
                .filter(h => printFilter === "all" || printFilter === h.id)
                .map(hall => {
                ...
                return (React.createElement("div", { key: hall.id, style: { background: "#FFFFFF",
                        border: `2px solid ${isTheoryHall ? "#A5F3FC" : "#6EE7B7"}`, borderRadius: 20, padding: 14, marginBottom: 14 } },
                    React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 10, flexWrap: "wrap" } },
                        ...
                        React.createElement("span", { style: { background: "#FEF3C7", color: "#92400E", borderRadius: 8, padding: "2px 8px", fontSize: 10, fontWeight: 700 } },
                            ...
                            hall.cap,
                            " \u0645\u062A\u062F\u0631\u0628"),
                        React.createElement("span", { style: { background: "#F0FDF9", color: "#0C4A6E", borderRadius: 8, padding: "2px 8px", fontSize: 10, fontWeight: 700 } },
                            hc.length,
                            " \u062D\u0635\u0629 \u0645\u062D\u062C\u0648\u0632\u0629"),
                        thCount > 0 && React.createElement("span", { style: { background: "#EFF6FF", color: "#0E7490", borderRadius: 8, padding: "2px 8px", fontSize: 10 } },
                            "\uD83D\uDCD8 ",
                            thCount,
                            " \u0646\u0638\u0631\u064A"),
        ...
        return (React.createElement("div", null,
            React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 18, flexWrap: "wrap", gap: 10 } },
                ...
                React.createElement("div", { style: { display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" } },
                    ...
                    React.createElement("div", { style: { display: "flex", gap: 10 } },
                        React.createElement("div", { style: { background: "#E0FDF9", border: "1px solid #A5F3FC", borderRadius: 16, padding: "8px 16px", textAlign: "center" } },
            ...
            modal === "importQuota" && (React.createElement("div", { style: { position: "fixed", inset: 0, background: "#00000099", zIndex: 4000,
                ...
                React.createElement("div", { style: { background: "#FFFFFF", borderRadius: 24, padding: 24, width: 520,
                    ...
                    React.createElement("div", { style: { background: "#E0FDF9", border: "1px solid #A5F3FC", borderRadius: 16,
                    ...
                    React.createElement("div", { style: { display: "flex", gap: 10 } },
                        React.createElement("button", { onClick: () => {
                                ...
                                alert(msg);
                            }, style: { flex: 1, background: "#0E7490", color: "#fff", border: "none", borderRadius: 16,
                                            ...
                                            React.createElement("td", { style: { padding: "5px 8px", border: "1px solid #E2E8F0", textAlign: "center" } },
                                                React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6, justifyContent: "center" } },
                                                    React.createElement("input", { type: "number", min: 0, defaultValue: quotaCounts[c.id] || "", key: c.id, onBlur: e => {
                                                            ...
                                                            border: `2px solid ${count > 0 ? "#10B981" : "#A5F3FC"}`,
                                        ...
                                        return (React.createElement("tr", { style: { background: "#F0F9FF" } },
                                            ...
                                            React.createElement("td", { style: { padding: "6px 10px", border: "1px solid #E2E8F0", textAlign: "center" } },
                                                React.createElement(Badge, { color: "#10B981" },
                                                    ...
                                                    " \u0634\u0639\u0628\u0629")),
                                            React.createElement("td", { style: { padding: "6px 10px", border: "1px solid #E2E8F0", textAlign: "center" } },
                                                React.createElement("span", { style: { background: "#0E7490", color: "#fff", borderRadius: 10,
                ...
                return (React.createElement("div", { style: { background: "linear-gradient(135deg,#1E3A5F,#1D4ED8)", borderRadius: 20, padding: 20, marginTop: 8 } },
                    ...
                    React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 12 } },
                        React.createElement("div", { style: { background: "#ffffff18", borderRadius: 16, padding: "12px", textAlign: "center" } },
                            ...
                            React.createElement("div", { style: { color: "#A5F3FC", fontWeight: 900, fontSize: 24 } }, totalTheoryGroups),
                    ...
                    React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 } }, specData.map((item) => {
                        ...
                        return (React.createElement("div", { key: specId, style: { background: "#FFFFFF", border: `2px solid ${sc}33`,
                            ...
                            React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginBottom: 10 } },
                                React.createElement("div", { style: { background: "#E0FDF9", borderRadius: 12, padding: "8px", textAlign: "center" } },
                            ...
                            React.createElement("div", { style: { marginBottom: 10 } },
                                ...
                                allEligible.map(t => {
                                    ...
                                    return (React.createElement("div", { key: t.id, style: { marginBottom: 8 } },
                                        ...
                                        React.createElement("div", { style: { background: "#A5F3FC", borderRadius: 149, height: 6, overflow: "hidden" } },
        ...
        React.createElement("div", { style: { position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 400,
            ...
            React.createElement("div", { style: { display: "flex", alignItems: "stretch" } }, TABS.map(t => {
                ...
                return (React.createElement("button", { key: t.id, onClick: () => setTab(t.id), style: { flex: 1, display: "flex", flexDirection: "column", alignItems: "center",
                        ...
                        background: active ? "#E0FDF9" : "#FFFFFF",
                        borderBottom: active ? "3px solid #3949AB" : "3px solid transparent",
