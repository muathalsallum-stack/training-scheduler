...
const Badge = ({ color, children, sm }) => (React.createElement("span", { style: { background: color + "22", color, border: `1px solid ${color}44`,
        borderRadius: 5, padding: sm ? "1px 6px" : "2px 8px", fontSize: sm ? 9 : 11, fontWeight: 700, whiteSpace: "nowrap" } }, children));
...
const Modal = ({ title, onClose, wide, children }) => (React.createElement("div", { style: { position: "fixed", inset: 0, background: "#000000bb", zIndex: 3000, display: "flex", alignItems: "center", justifyContent: "center" } },
    React.createElement("div", { style: { background: "#FFFFFF", border: "1px solid #1e2d45", borderRadius: 16, padding: 26,
            width: wide ? 860 : 480, maxHeight: "88vh", overflow: "auto", direction: "rtl" } },
        React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 18 } },
            React.createElement("h3", { style: { color: "#042F2E", margin: 0, fontSize: 16 } }, title),
            React.createElement("button", { onClick: onClose, style: { background: "none", border: "none", color: "#0F766E", cursor: "pointer", fontSize: 22 } }, "\u00D7")),
        children)));
const Fld = ({ label, value, onChange, type = "text", min, max, note }) => (React.createElement("div", { style: { marginBottom: 13 } },
    React.createElement("div", { style: { color: "#0F766E", fontSize: 11, marginBottom: 5 } }, label),
    React.createElement("input", { type: type, value: value, onChange: e => onChange(e.target.value), min: min, max: max, style: { width: "100%", background: "#FFFFFF", border: "1px solid #1e3a5f", borderRadius: 8,
            padding: "8px 12px", color: "#134E4A", fontSize: 13, boxSizing: "border-box", direction: "rtl" } }),
    note && React.createElement("div", { style: { color: "#0F766E", fontSize: 10, marginTop: 3 } }, note)));
const Sel = ({ label, value, onChange, opts, note }) => (React.createElement("div", { style: { marginBottom: 13 } },
    label && React.createElement("div", { style: { color: "#0F766E", fontSize: 11, marginBottom: 5 } }, label),
    React.createElement("select", { value: value, onChange: e => onChange(e.target.value), style: { width: "100%", background: "#FFFFFF", border: "1px solid #1e3a5f", borderRadius: 8,
            padding: "8px 12px", color: "#134E4A", fontSize: 13, direction: "rtl" } }, opts.map(o => React.createElement("option", { key: o.v, value: o.v }, o.l))),
    note && React.createElement("div", { style: { color: "#0F766E", fontSize: 10, marginTop: 3 } }, note)));
// ══════════════════════════════════════════════════════════════
...
function SchedCell({ cell, courses, trainers, halls, spColor, mainSpec, onRemove, onUpdate, sched, periods, conflicts, sharedWith, allGroups, onAddShared }) {
    ...
    const avTr = trainers.filter(t => t.specs.includes(c.spec) || t.specs.includes(mainSpec) || t.specs.includes("gen"));
    ...
    return (React.createElement("div", { draggable: true, onDragStart: e => e.dataTransfer.setData("moveCell", JSON.stringify({ id: cell.id, day: cell.day, period: cell.period })), style: { background: hasConflict ? "#FEF2F2" : color + "11",
        ...
        React.createElement("button", { onClick: onRemove, style: { position: "absolute", top: 2, left: 4, background: "none", border: "none",
                color: "#EF4444", cursor: "pointer", fontSize: 12, lineHeight: 1, padding: 0 } }, "\u00D7"),
        React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", paddingLeft: 12, marginBottom: 2 } },
            ...
            React.createElement("div", { style: { background: color, color: "#fff", borderRadius: 4, padding: "0 5px", fontSize: 9, fontWeight: 700, lineHeight: "16px" } },
                sessionH,
                "\u0633")),
        React.createElement("div", { style: { color: "#134E4A", fontSize: 9, marginBottom: isShared ? 2 : 4, lineHeight: 1.3 } }, c.name),
        isShared && (React.createElement("div", { style: { marginBottom: 4 } },
            React.createElement("div", { style: { background: "#FEF3C7", border: "1px solid #F59E0B", borderRadius: 5,
        ...
        React.createElement("div", { style: { marginBottom: 4 } },
            React.createElement("input", { value: cell.refNumber || "", onChange: e => onUpdate({ refNumber: e.target.value }), placeholder: "\u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u0645\u0631\u062C\u0639\u064A...", onClick: e => e.stopPropagation(), onMouseDown: e => e.stopPropagation(), style: { width: "100%", background: "#F0FDFA", border: "1px solid #CBD5E1", borderRadius: 5,
        ...
        React.createElement("div", { style: { marginBottom: 4 } },
            React.createElement("div", { style: { color: "#0F766E", fontSize: 9, marginBottom: 2 } },
                "\u0639\u062F\u062F \u0633\u0627\u0639\u0627\u062A \u0627\u0644\u062C\u0644\u0633\u0629:",
                React.createElement("span", { style: { color: sessionType === "practical" ? "#10B981" : "#0891B2", marginRight: 4, fontWeight: 700 } },
                    "(max ",
                    maxH,
                    ")")),
        ...
        (isTheory || (hasBoth && sessionType === "theory")) && (React.createElement("div", { style: { marginBottom: 3 } },
            React.createElement("div", { style: { color: "#0E7490", fontSize: 9, marginBottom: 1 } }, "\uD83D\uDC68\u200D\uD83C\uDFEB \u0645\u062F\u0631\u0628 \u0627\u0644\u0646\u0638\u0631\u064A:"),
            React.createElement("select", { value: cell.theoryTrainerId || "", onChange: e => onUpdate({ theoryTrainerId: e.target.value || null }), style: { width: "100%", background: "#E0FDF9", border: "1px solid #BFDBFE", borderRadius: 4,
                    color: "#1E40AF", fontSize: 9, padding: "2px 4px" } },
                React.createElement("option", { value: "" }, "-- \u0627\u062E\u062A\u0631 \u0645\u062F\u0631\u0628\u0627\u064B --"),
                avTr.map(t => React.createElement("option", { key: t.id, value: t.id }, t.name))))),
        (!isTheory && (sessionType === "practical" || !hasBoth)) && (React.createElement("div", { style: { marginBottom: 3 } },
            ...
            React.createElement("select", { value: cell.practicalTrainerId || "", onChange: e => onUpdate({ practicalTrainerId: e.target.value || null }), style: { width: "100%", background: "#ECFDF5", border: "1px solid #A7F3D0", borderRadius: 4,
                    color: "#065F46", fontSize: 9, padding: "2px 4px" } },
                React.createElement("option", { value: "" }, "-- \u0627\u062E\u062A\u0631 \u0645\u062F\u0631\u0628\u0627\u064B --"),
                avTr.map(t => React.createElement("option", { key: t.id, value: t.id }, t.name))))),
        React.createElement("div", null,
            React.createElement("div", { style: { color: "#0F766E", fontSize: 9, marginBottom: 1 } }, "\uD83C\uDFDB \u0627\u0644\u0642\u0627\u0639\u0629:"),
            React.createElement("select", { value: cell.hallId || "", onChange: e => onUpdate({ hallId: e.target.value || null }), style: { width: "100%", background: "#F0FDFA", border: "1px solid #CBD5E1", borderRadius: 4,
        ...
        !cell.isSharedCopy && onAddShared && (React.createElement("div", { style: { marginTop: 5, borderTop: "1px solid #E2E8F0", paddingTop: 5 } },
            React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6, marginBottom: 4 } },
                React.createElement("span", { style: { color: "#0F766E", fontSize: 9, fontWeight: 700 } }, "\uD83D\uDD17 \u0645\u0634\u062A\u0631\u0643 \u0645\u0639 \u0631\u0632\u0645\u0629\u061F"),
                React.createElement("div", { style: { display: "flex", gap: 4 } },
                    React.createElement("button", { onClick: () => onUpdate({ showSharing: true }), style: { padding: "2px 8px", borderRadius: 4, fontSize: 8, fontWeight: 700, cursor: "pointer",
                            ...
                            color: cell.showSharing ? "#fff" : "#0F766E", border: "1px solid #CBD5E1" } }, "\u0646\u0639\u0645"),
                    React.createElement("button", { onClick: () => onUpdate({ showSharing: false, sharedGroupKeys: [] }), style: { padding: "2px 8px", borderRadius: 4, fontSize: 8, fontWeight: 700, cursor: "pointer",
                            ...
                            color: "#0F766E", border: "1px solid #CBD5E1" } }, "\u0644\u0627"))),
            cell.showSharing && allGroups && allGroups.length > 0 && (React.createElement("div", { style: { background: "#FFFBEB", border: "1px solid #F59E0B", borderRadius: 6, padding: 6 } },
                ...
                React.createElement("div", { style: { maxHeight: 120, overflowY: "auto" } }, allGroups.map(g => {
                    ...
                    return (React.createElement("label", { key: g.key, style: { display: "flex", alignItems: "center", gap: 6,
                        ...
                        React.createElement("span", { style: { fontSize: 8, color: "#0F766E" } }, g.label),
                        g.exists && React.createElement("span", { style: { fontSize: 7, color: "#F59E0B", fontWeight: 700 } }, "\u0645\u0648\u062C\u0648\u062F")));
                })),
                (cell.sharedGroupKeys || []).length > 0 && (React.createElement("button", { onClick: () => onAddShared(cell.sharedGroupKeys || []), style: { width: "100%", marginTop: 5, padding: "4px", background: "#10B981", color: "#fff",
                        border: "none", borderRadius: 5, fontSize: 9, fontWeight: 700, cursor: "pointer" } },
                    "\u2705 \u0646\u0633\u062E \u0644\u0644\u0631\u0632\u0645 \u0627\u0644\u0645\u062E\u062A\u0627\u0631\u0629 (",
                    (cell.sharedGroupKeys || []).length,
                    ")")))),
            isShared && (React.createElement("div", { style: { marginTop: 4, background: "#E0FDF9", border: "1px solid #BFDBFE",
                    borderRadius: 5, padding: "3px 6px" } },
                React.createElement("div", { style: { color: "#0E7490", fontSize: 8, fontWeight: 700 } }, "\uD83D\uDD17 \u0645\u0646\u0633\u0648\u062E \u0644\u0640:"),
                sharedWith.map((sw, i) => (React.createElement("div", { key: i, style: { color: "#0891B2", fontSize: 8 } }, sw)))))))));
}
// ══════════════════════════════════════════════════════════════
...
function PeriodSettingsModal({ periods, setPeriods, onClose }) {
    ...
    return (React.createElement(Modal, { title: "\u2699\uFE0F \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0623\u0648\u0642\u0627\u062A \u0627\u0644\u062D\u0635\u0635", onClose: onClose, wide: true },
        React.createElement("div", { style: { background: "#FFFFFF", borderRadius: 10, padding: 12, marginBottom: 14 } },
            React.createElement("div", { style: { color: "#0F766E", fontSize: 11, marginBottom: 8 } },
                "\uD83D\uDD50 \u0643\u0644 \u062D\u0635\u0629 = ",
            ...
            React.createElement("div", { style: { color: "#0F766E", fontSize: 10 } }, "\u26A0\uFE0F \u0627\u0644\u0646\u0638\u0631\u064A: \u0644\u0627 \u064A\u0645\u0643\u0646 \u062A\u062C\u0627\u0648\u0632 3 \u062D\u0635\u0635 \u0645\u062A\u062A\u0627\u0644\u064A\u0629 \u00A0|\u00A0 \u0627\u0644\u0639\u0645\u0644\u064A: \u064A\u064F\u0633\u0645\u062D \u0628\u0640 4 \u062D\u0635\u0635 \u0645\u062A\u062A\u0627\u0644\u064A\u0629")),
        React.createElement("div", { style: { overflowX: "auto" } },
            React.createElement("table", { style: { borderCollapse: "collapse", width: "100%", fontSize: 12 } },
                React.createElement("thead", null,
                    React.createElement("tr", { style: { background: "#F0FDFA" } }, ["الحصة", "من", "إلى", "استراحة بعدها", "من", "إلى", "المدة"].map(h => (React.createElement("th", { key: h, style: { color: "#0F766E", padding: "8px 10px", border: "1px solid #1e2d45", textAlign: "center" } }, h))))),
                React.createElement("tbody", null, local.map((p, i) => (React.createElement(React.Fragment, null,
                    React.createElement("tr", { key: p.id, style: { background: i % 2 === 0 ? "#0C4A6E" : "#FFFFFF" } },
                        ...
                        React.createElement("td", { style: { padding: "6px 8px", border: "1px solid #1e2d45" } },
                            React.createElement("input", { type: "time", value: p.start, onChange: e => update(i, "start", e.target.value), style: { background: "#FFFFFF", border: "1px solid #1e3a5f", borderRadius: 6, padding: "4px 8px", color: "#134E4A", fontSize: 12, direction: "ltr" } })),
                        React.createElement("td", { style: { padding: "6px 8px", border: "1px solid #1e2d45" } },
                            React.createElement("input", { type: "time", value: p.end, onChange: e => update(i, "end", e.target.value), style: { background: "#FFFFFF", border: "1px solid #1e3a5f", borderRadius: 6, padding: "4px 8px", color: "#134E4A", fontSize: 12, direction: "ltr" } })),
                        React.createElement("td", { style: { padding: "6px 8px", border: "1px solid #1e2d45", textAlign: "center" } },
                            React.createElement("button", { onClick: () => toggleBreak(i), style: { background: p.breakAfter ? "#065F46" : "#FFFFFF", border: `1px solid ${p.breakAfter ? "#10b981" : "#99F6E4"}`,
                                    color: p.breakAfter ? "#6ee7b7" : "#0F766E", borderRadius: 6, padding: "3px 10px", cursor: "pointer", fontSize: 11 } }, p.breakAfter ? "✓ يوجد" : "+ أضف")),
                        p.breakAfter ? (React.createElement(React.Fragment, null,
                            ...
                            React.createElement("td", { style: { padding: "6px 8px", border: "1px solid #1e2d45", textAlign: "center" } },
                                ...
                                React.createElement("span", { style: { color: "#0F766E", fontSize: 10, marginRight: 3 } }, "\u062F")))) : (React.createElement(React.Fragment, null,
                            React.createElement("td", { style: { border: "1px solid #1e2d45", background: "#F0FDFA" }, colSpan: 3 })))),
        ...
        React.createElement("div", { style: { display: "flex", gap: 10, marginTop: 16 } },
            ...
            React.createElement(Btn, { onClick: () => { setLocal(DEFAULT_PERIOD_CONFIG.map(p => (Object.assign(Object.assign({}, p), { breakAfter: p.breakAfter ? Object.assign({}, p.breakAfter) : null })))); }, bg: "#99F6E4", outline: true }, "\u21BA \u0625\u0639\u0627\u062F\u0629 \u0627\u0644\u0636\u0628\u0637"))));
}
// ══════════════════════════════════════════════════════════════
...
function CourseAssignModal({ courses, trainers, assignments, setAssignments, onClose }) {
    ...
    const spColor = id => { var _a; return ((_a = SPECIALIZATIONS.find(s => s.id === id)) === null || _a === void 0 ? void 0 : _a.color) || "#0F766E"; };
    ...
    return (React.createElement(Modal, { title: "\uD83D\uDCCB \u062A\u062E\u0635\u064A\u0635 \u0627\u0644\u0645\u062F\u0631\u0628\u064A\u0646 \u0644\u0644\u0645\u0642\u0631\u0631\u0627\u062A", onClose: onClose, wide: true },
        React.createElement("div", { style: { background: "#FFFFFF", borderRadius: 8, padding: 10, marginBottom: 14, fontSize: 11, color: "#0F766E", lineHeight: 1.8 } }, "\u0647\u0646\u0627 \u064A\u0645\u0643\u0646\u0643 \u062A\u062E\u0635\u064A\u0635 \u0645\u062F\u0631\u0628 \u062B\u0627\u0628\u062A \u0644\u0643\u0644 \u0645\u0642\u0631\u0631 (\u0646\u0638\u0631\u064A \u0648/\u0623\u0648 \u0639\u0645\u0644\u064A). \u0639\u0646\u062F \u0648\u0636\u0639 \u0627\u0644\u0645\u0642\u0631\u0631 \u0641\u064A \u0627\u0644\u062C\u062F\u0648\u0644\u060C \u0633\u064A\u064F\u0639\u0628\u0623 \u0627\u0644\u0645\u062F\u0631\u0628 \u062A\u0644\u0642\u0627\u0626\u064A\u0627\u064B. \u064A\u0645\u0643\u0646 \u0623\u0646 \u064A\u0643\u0648\u0646 \u0645\u062F\u0631\u0628 \u0627\u0644\u0646\u0638\u0631\u064A \u0645\u062E\u062A\u0644\u0641\u0627\u064B \u0639\u0646 \u0645\u062F\u0631\u0628 \u0627\u0644\u0639\u0645\u0644\u064A."),
        React.createElement("div", { style: { display: "flex", gap: 8, marginBottom: 14, flexWrap: "wrap" } }, [{ id: "all", name: "الكل", color: "#0F766E" }, ...SPECIALIZATIONS].map(s => (React.createElement("button", { key: s.id, onClick: () => setFilterSpec(s.id), style: { padding: "5px 12px", borderRadius: 7, border: `1px solid ${s.color}55`,
        ...
        React.createElement("div", { style: { overflowX: "auto" } },
            React.createElement("table", { style: { borderCollapse: "collapse", width: "100%", fontSize: 12 } },
                React.createElement("thead", null,
                    React.createElement("tr", { style: { background: "#F0FDFA" } }, ["التخصص", "الفصل", "الرمز", "اسم المقرر", "نوع الساعات", "مدرب النظري", "مدرب العملي"].map(h => (React.createElement("th", { key: h, style: { color: "#0F766E", padding: "8px 10px", border: "1px solid #1e2d45", textAlign: "center", whiteSpace: "nowrap" } }, h))))),
                React.createElement("tbody", null, vis.map(c => {
                    ...
                    return (React.createElement("tr", { key: c.id, style: { borderBottom: "1px solid #1a2535" } },
                        ...
                        React.createElement("td", { style: { padding: "7px 10px", textAlign: "center", color: "#0F766E", border: "1px solid #1a2535" } }, c.level),
                        ...
                        React.createElement("td", { style: { padding: "7px 10px", color: "#134E4A", border: "1px solid #1a2535" } }, c.name),
                        ...
                        React.createElement("td", { style: { padding: "6px 8px", border: "1px solid #1a2535" } }, (!isPract) ? (React.createElement("select", { value: a.theoryId || "", onChange: e => setAssign(c.id, "theoryId", e.target.value || null), style: { width: "100%", background: "#FFFFFF", border: "1px solid #1e40af", borderRadius: 6,
                            ...
                            avTr.map(t => React.createElement("option", { key: t.id, value: t.id }, t.name)))) : React.createElement("span", { style: { color: "#99F6E4", fontSize: 10 } }, "\u0644\u0627 \u064A\u0648\u062C\u062F \u0646\u0638\u0631\u064A")),
                        React.createElement("td", { style: { padding: "6px 8px", border: "1px solid #1a2535" } }, c.P > 0 ? (React.createElement("select", { value: a.practicalId || "", onChange: e => setAssign(c.id, "practicalId", e.target.value || null), style: { width: "100%", background: "#FFFFFF", border: "1px solid #064e3b", borderRadius: 6,
                            ...
                            React.createElement("option", { value: "" }, "-- \u063A\u064A\u0631 \u0645\u062D\u062F\u062F --"),
                            avTr.map(t => React.createElement("option", { key: t.id, value: t.id }, t.name)))) : React.createElement("span", { style: { color: "#99F6E4", fontSize: 10 } }, "\u0644\u0627 \u064A\u0648\u062C\u062F \u0639\u0645\u0644\u064A"))));
                })))),
...
function App() {
    ...
    const loadUsers = async () => {
        try {
            ...
            const keys = (result === null || result === void 0 ? void 0 : result.keys) || [];
    ...
    // Configurable capacity limits (overrides default 35/20)
    const [theoryCap, setTheoryCap] = (0, React.useState)(35);
    const [practCap, setPractCap] = (0, React.useState)(20);
    const spColor = id => { var _a; return ((_a = SPECIALIZATIONS.find(s => s.id === id)) === null || _a === void 0 ? void 0 : _a.color) || "#0F766E"; };
    const spName = id => { var _a; return ((_a = SPECIALIZATIONS.find(s => s.id === id)) === null || _a === void 0 ? void 0 : _a.name) || id; };
    // ── Group helpers ─────────────────────────────────────────
    ...
    const addSharedCopies = (cell, fromSpec, fromLv, fromGid, keys) => {
        keys.forEach(key => {
            ...
            const tConflict = checkTrainerConflict(cell.theoryTrainerId, cell.day, cell.period)
                || checkTrainerConflict(cell.practicalTrainerId, cell.day, cell.period);
            const hConflict = checkHallConflict(cell.hallId, cell.day, cell.period);
            if (tConflict || hConflict) {
                const grps = (groups[sp] && groups[sp][+lv]) || [];
                const grp = grps.find(g => g.id === gid);
                setWarn(`⚠️ تنبيه لـ ${(grp === null || grp === void 0 ? void 0 : grp.name) || gid}: ${tConflict || hConflict}`);
                setTimeout(() => setWarn(null), 5000);
            }
            // Add as shared copy (isSharedCopy=true so trainer hours not counted again)
            setSched(sp, +lv, gid, p => [...p, Object.assign(Object.assign({}, cell), { id: uid(), isSharedCopy: true, sourceId: cell.id, showSharing: false, sharedGroupKeys: [] })]);
        });
        // Update source cell to clear pending keys
        handleCellUpdate(fromSpec, fromLv, fromGid, cell.id, { sharedGroupKeys: [], showSharing: false });
    };
    ...
    const checkTrainerConflict = (trainerId, day, period, excludeId = null) => {
        ...
        if (!trainerId)
            return null;
        const all = getAllCells();
        const conflict = all.find(c => c.id !== excludeId &&
            c.day === day && c.period === period &&
            (c.theoryTrainerId === trainerId || c.practicalTrainerId === trainerId));
        if (!conflict)
            return null;
    ...
    // Check hall conflict: same hall, same day, same period (across ALL groups/specs)
    ...
    const PeriodLabel = ({ pid }) => {
        ...
        return (React.createElement("div", { style: { textAlign: "center" } },
            React.createElement("div", { style: { fontWeight: 700, fontSize: 11 } },
                "\u0627\u0644\u062D\u0635\u0629 ",
                p.label),
            React.createElement("div", { style: { fontSize: 9, color: "#0F766E", direction: "ltr" } },
                p.start,
                "\u2013",
                p.end)));
    };
    ...
    const PeriodSidebar = ({ pid }) => {
        ...
        if (!p)
            return null;
        return (React.createElement("td", { style: { background: "#F0FDFA", padding: "4px 6px", border: "1px solid #1e2d45",
                verticalAlign: "top", minWidth: 88 } },
            React.createElement("div", { style: { textAlign: "center" } },
                React.createElement("div", { style: { color: "#0ea5e9", fontWeight: 700, fontSize: 11 } }, p.label),
                React.createElement("div", { style: { color: "#0F766E", fontSize: 9, direction: "ltr" } }, p.start),
                React.createElement("div", { style: { color: "#0F766E", fontSize: 9, direction: "ltr" } }, p.end))));
    };
    // ── Break Row ─────────────────────────────────────────────
    ...
    const Dashboard = () => {
        ...
        return (React.createElement("div", null,
            React.createElement("h2", { style: { color: "#042F2E", fontSize: 19, marginBottom: 20 } }, "\u0627\u0644\u0631\u0626\u064A\u0633\u064A\u0629"),
            React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: 12, marginBottom: 20 } }, [
            ...
            ].map(s => (React.createElement("div", { key: s.l, style: { background: "#FFFFFF", border: `1px solid ${s.c}33`, borderRadius: 13, padding: "14px 16px" } },
                ...
                React.createElement("div", { style: { color: "#0C4A6E", fontSize: 11, fontWeight: 600 } }, s.l),
                React.createElement("div", { style: { color: "#0F766E", fontSize: 10, marginTop: 2 } }, s.s))))),
            React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr", gap: 12, marginBottom: 20 } },
                React.createElement("div", { style: { background: "#FFFFFF", border: "2px solid #0E7490", borderRadius: 14, padding: 16 } },
                    React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" } },
                        React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10 } },
                            React.createElement("div", { style: { width: 40, height: 40, background: "#E0FDF9", borderRadius: 10,
                                    display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20 } }, "\uD83D\uDCE5"),
                            React.createElement("div", null,
                                React.createElement("div", { style: { color: "#042F2E", fontWeight: 800, fontSize: 14 } }, "\u0627\u0633\u062A\u064A\u0631\u0627\u062F \u0627\u0644\u062E\u0637\u0629 \u0627\u0644\u062A\u062F\u0631\u064A\u0628\u064A\u0629"),
                                React.createElement("div", { style: { color: "#0F766E", fontSize: 11 } }, "\u0627\u0633\u062A\u064A\u0631\u0627\u062F \u0627\u0644\u0645\u0642\u0631\u0631\u0627\u062A \u0645\u0646 \u0645\u0644\u0641 Excel"))),
                        React.createElement("button", { onClick: () => setShowPlanImport(p => !p), style: { padding: "7px 14px", borderRadius: 9, border: "1px solid #0E7490",
                                background: showPlanImport ? "#0E7490" : "#E0FDF9",
                                color: showPlanImport ? "#fff" : "#0C4A6E", cursor: "pointer", fontSize: 12, fontWeight: 700 } }, showPlanImport ? "▲ إخفاء" : "▼ فتح")),
                    showPlanImport && (React.createElement("div", { style: { marginTop: 14, padding: "14px", background: "#F0FDFA", borderRadius: 10 } },
                        React.createElement("div", { style: { color: "#0C4A6E", fontSize: 11, lineHeight: 1.9, marginBottom: 10 } }, "\u0627\u0644\u0635\u0642 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062E\u0637\u0629 \u0627\u0644\u062A\u062F\u0631\u064A\u0628\u064A\u0629 \u0645\u0646 Excel (\u0631\u0645\u0632 \u0627\u0644\u0645\u0642\u0631\u0631\u060C \u0627\u0644\u0627\u0633\u0645\u060C \u0627\u0644\u0633\u0627\u0639\u0627\u062A...)"),
                        React.createElement("textarea", { rows: 5, placeholder: "ICMT 121\tتجميع الحاسب وتشغيله\t1\t0\t4\t5\nINET 111\tمبادئ شبكات الحاسب\t3\t0\t2\t5", id: "plan-paste", style: { width: "100%", border: "1px solid #A5F3FC", borderRadius: 8, padding: 10,
                                fontSize: 10, fontFamily: "monospace", direction: "ltr", background: "#FFFFFF",
                                boxSizing: "border-box", resize: "vertical" } }),
                        React.createElement("div", { style: { color: "#0F766E", fontSize: 10, marginTop: 6 } }, "\uD83D\uDCA1 \u0627\u0644\u0623\u0639\u0645\u062F\u0629 \u0627\u0644\u0645\u062A\u0648\u0642\u0639\u0629: \u0631\u0645\u0632 \u0627\u0644\u0645\u0642\u0631\u0631 | \u0627\u0644\u0627\u0633\u0645 | \u0645\u062D\u0627\u0636\u0631\u0629 | \u062A\u0645\u0627\u0631\u064A\u0646 | \u0639\u0645\u0644\u064A | (\u0625\u062C\u0645\u0627\u0644\u064A)"),
                        React.createElement("button", { onClick: () => {
                                ...
                                border: "none", borderRadius: 9, cursor: "pointer", fontSize: 12, fontWeight: 700 } }, "\u2705 \u0627\u0633\u062A\u064A\u0631\u0627\u062F \u0627\u0644\u0645\u0642\u0631\u0631\u0627\u062A")))),
                React.createElement("div", { style: { background: "#FFFFFF", border: "2px solid #8B5CF6", borderRadius: 14, padding: 16 } },
                    React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" } },
                        React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10 } },
                            React.createElement("div", { style: { width: 40, height: 40, background: "#EDE9FE", borderRadius: 10,
                                    display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20 } }, "\uD83D\uDC65"),
                            React.createElement("div", null,
                                React.createElement("div", { style: { color: "#042F2E", fontWeight: 800, fontSize: 14 } }, "\u0627\u0633\u062A\u064A\u0631\u0627\u062F \u0627\u0644\u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u0645\u062A\u0648\u0642\u0639"),
                        ...
                        React.createElement("button", { onClick: () => setShowEnrollImport(p => !p), style: { padding: "7px 14px", borderRadius: 9, border: "1px solid #8B5CF6",
                    ...
                    showEnrollImport && (React.createElement("div", { style: { marginTop: 14, padding: 14, background: "#FAF5FF", borderRadius: 10 } },
                        React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 10 } },
                            React.createElement("div", null,
                                ...
                                React.createElement("select", { id: "enr-code-col", defaultValue: "0", style: { width: "100%", border: "1px solid #DDD6FE", borderRadius: 7, padding: "6px 8px", fontSize: 11, background: "#FFFFFF" } }, ["العمود 1", "العمود 2", "العمود 3", "العمود 4", "العمود 5"].map((l, i) => React.createElement("option", { key: i, value: i }, l)))),
                            React.createElement("div", null,
                                React.createElement("label", { style: { display: "block", color: "#6D28D9", fontSize: 11, fontWeight: 700, marginBottom: 3 } }, "\u0639\u0645\u0648\u062F \u0639\u062F\u062F \u0627\u0644\u0645\u062A\u062F\u0631\u0628\u064A\u0646"),
                                React.createElement("select", { id: "enr-count-col", defaultValue: "1", style: { width: "100%", border: "1px solid #DDD6FE", borderRadius: 7, padding: "6px 8px", fontSize: 11, background: "#FFFFFF" } }, ["العمود 1", "العمود 2", "العمود 3", "العمود 4", "العمود 5"].map((l, i) => React.createElement("option", { key: i, value: i }, l))))),
                        ...
                        React.createElement("div", { style: { display: "flex", gap: 8, marginTop: 10 } },
                            ...
                            React.createElement("button", { onClick: () => setShowEnrollImport(false), style: { padding: "10px 14px", background: "#EDE9FE", color: "#6D28D9", border: "none",
                                    borderRadius: 9, cursor: "pointer", fontSize: 12 } }, "\u0625\u0644\u063A\u0627\u0621"))))),
                React.createElement("div", { style: { background: "#FFFFFF", border: "2px solid #F97316", borderRadius: 14, padding: 16 } },
                    React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" } },
                        React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10 } },
                            React.createElement("div", { style: { width: 40, height: 40, background: "#FFF7ED", borderRadius: 10,
                                    display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20 } }, "\u2699\uFE0F"),
                            React.createElement("div", null,
                                React.createElement("div", { style: { color: "#042F2E", fontWeight: 800, fontSize: 14 } }, "\u0642\u064A\u0648\u062F \u0627\u0644\u0634\u0639\u0628 \u0627\u0644\u062A\u062F\u0631\u064A\u0628\u064A\u0629"),
                                React.createElement("div", { style: { color: "#C2410C", fontSize: 11 } },
                                    ...
                                    practCap,
                                    " \u0645\u062A\u062F\u0631\u0628/\u0634\u0639\u0628\u0629"))),
                        React.createElement("button", { onClick: () => setShowLimits(p => !p), style: { padding: "7px 14px", borderRadius: 9, border: "1px solid #F97316",
                    ...
                    showLimits && (React.createElement("div", { style: { marginTop: 14, padding: 14, background: "#FFF7ED", borderRadius: 10 } },
                        React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 12 } },
                            React.createElement("div", null,
                                ...
                                React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8 } },
                                    React.createElement("input", { type: "number", min: 1, max: 100, value: localTheory, onChange: e => setLocalTheory(+e.target.value || 35), style: { width: 70, border: "2px solid #F97316", borderRadius: 8, padding: "8px",
                            ...
                            React.createElement("div", null,
                                ...
                                React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8 } },
                                    React.createElement("input", { type: "number", min: 1, max: 100, value: localPract, onChange: e => setLocalPract(+e.target.value || 20), style: { width: 70, border: "2px solid #10B981", borderRadius: 8, padding: "8px",
                        ...
                        React.createElement("button", { onClick: () => {
                                ...
                                borderRadius: 9, cursor: "pointer", fontSize: 13, fontWeight: 700 } }, "\u2705 \u062D\u0641\u0638 \u0627\u0644\u0642\u064A\u0648\u062F"))))),
            React.createElement("div", { style: { background: "#FFFFFF", border: "1px solid #A5F3FC", borderRadius: 13, padding: 16, marginBottom: 16 } },
                React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 } },
                    React.createElement("div", { style: { color: "#042F2E", fontWeight: 700, fontSize: 13 } }, "\u23F0 \u062C\u062F\u0648\u0644 \u0627\u0644\u062D\u0635\u0635 \u0627\u0644\u064A\u0648\u0645\u064A"),
                    React.createElement(Btn, { onClick: () => setModal("periodSettings"), bg: "#E0FDF9", outline: true, sm: true }, "\u2699\uFE0F \u062A\u0639\u062F\u064A\u0644")),
                React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 6 } }, periods.map(p => (React.createElement("div", { key: p.id, style: { background: "#E0FDF9", border: "1px solid #A5F3FC", borderRadius: 8, padding: "6px 12px", textAlign: "center", minWidth: 90 } },
                    React.createElement("div", { style: { color: "#0E7490", fontWeight: 700, fontSize: 11 } },
                        "\u0627\u0644\u062D\u0635\u0629 ",
                        p.label),
                    React.createElement("div", { style: { color: "#0C4A6E", fontSize: 10, direction: "ltr" } },
                        p.start,
                        "\u2013",
                        p.end))))))));
    };
    ...
    const CoursesTab = () => {
        ...
        return (React.createElement("div", null,
            React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 18 } },
                React.createElement("h2", { style: { color: "#042F2E", margin: 0, fontSize: 18 } }, "\u0627\u0644\u0645\u0642\u0631\u0631\u0627\u062A \u0627\u0644\u062A\u062F\u0631\u064A\u0628\u064A\u0629"),
            ...
            React.createElement("div", { style: { display: "flex", gap: 8, marginBottom: 16, flexWrap: "wrap" } },
                [{ id: "all", name: "الكل", color: "#0F766E" }, ...SPECIALIZATIONS].map(s => (React.createElement("button", { key: s.id, onClick: () => setFs(s.id), style: { padding: "5px 12px", borderRadius: 8, border: `1px solid ${s.color}55`,
                        background: fs === s.id ? s.color : "transparent", color: fs === s.id ? "#fff" : s.color, cursor: "pointer", fontSize: 12, fontWeight: 600 } }, s.name))),
                React.createElement("div", { style: { marginRight: "auto", display: "flex", gap: 5 } }, [{ v: 0, l: "الكل" }, ...[1, 2, 3, 4, 5].map(x => ({ v: x, l: "فصل " + x }))].map(o => (React.createElement("button", { key: o.v, onClick: () => setFl(o.v), style: { padding: "5px 11px", borderRadius: 8, border: "1px solid #2a3a55",
                        background: fl === o.v ? "#99F6E4" : "transparent", color: fl === o.v ? "#134E4A" : "#0F766E", cursor: "pointer", fontSize: 12 } }, o.l))))),
            React.createElement("div", { style: { overflowX: "auto", background: "#FFFFFF", border: "1px solid #1e2d45", borderRadius: 13 } },
                React.createElement("table", { style: { borderCollapse: "collapse", width: "100%", fontSize: 12 } },
                    React.createElement("thead", null,
                        React.createElement("tr", { style: { background: "#F0FDFA" } }, ["الرمز", "الرمز العربي", "اسم المقرر", "التخصص", "الفصل", "مح", "عم", "مت", "س.أ", "مدرب النظري", "مدرب العملي", ""].map(h => (React.createElement("th", { key: h, style: { color: "#0F766E", padding: "8px 10px", border: "1px solid #1e2d45", whiteSpace: "nowrap", textAlign: "center" } }, h))))),
                    React.createElement("tbody", null, vis.map(c => {
                        ...
                        return (React.createElement("tr", { key: c.id },
                            ...
                            React.createElement("td", { style: { padding: "7px 10px", color: "#0F766E", fontFamily: "monospace", fontSize: 11, border: "1px solid #1a2535" } }, c.ar),
                            React.createElement("td", { style: { padding: "7px 10px", color: "#134E4A", border: "1px solid #1a2535" } }, c.name),
                            React.createElement("td", { style: { padding: "7px 10px", textAlign: "center", border: "1px solid #1a2535" } },
                            ...
                            React.createElement("td", { style: { padding: "7px 10px", border: "1px solid #1a2535" } }, tTr ? React.createElement(Badge, { color: "#3b82f6" }, tTr.name) : React.createElement("span", { style: { color: "#99F6E4", fontSize: 10 } }, "\u2014")),
                            React.createElement("td", { style: { padding: "7px 10px", border: "1px solid #1a2535" } }, pTr ? React.createElement(Badge, { color: "#10b981" }, pTr.name) : React.createElement("span", { style: { color: "#99F6E4", fontSize: 10 } }, "\u2014")),
                            React.createElement("td", { style: { padding: "7px 10px", textAlign: "center", border: "1px solid #1a2535" } },
                ...
                React.createElement("div", { style: { padding: "8px 14px", color: "#99F6E4", fontSize: 11 } },
                    vis.length,
                    " \u0645\u0642\u0631\u0631")),
            modal === "addCourse" && (React.createElement(Modal, { title: "\u0625\u0636\u0627\u0641\u0629 \u0645\u0642\u0631\u0631 \u062C\u062F\u064A\u062F", onClose: () => setModal(null) },
                ...
                React.createElement("div", { style: { background: "#FFFFFF", borderRadius: 8, padding: 10, marginBottom: 14, fontSize: 12, color: "#0F766E" } },
    ...
    const TrainersTab = () => {
        ...
        return (React.createElement("div", null,
            React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 18 } },
                React.createElement("h2", { style: { color: "#042F2E", margin: 0, fontSize: 18 } }, "\u0627\u0644\u0645\u062F\u0631\u0628\u0648\u0646"),
                React.createElement(Btn, { onClick: () => setModal("importTrainersExcel"), bg: "#10b981", outline: true, sm: true }, "\uD83D\uDCCA \u0627\u0633\u062A\u064A\u0631\u0627\u062F Excel"),
                React.createElement(Btn, { onClick: () => setModal("addTrainer"), bg: "#8b5cf6" }, "+ \u0625\u0636\u0627\u0641\u0629 \u0645\u062F\u0631\u0628")),
            React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(260px,1fr))", gap: 14 } }, trainers.map(t => {
                ...
                return (React.createElement("div", { key: t.id, style: { background: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: 13, padding: 18 } },
                    React.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: 10 } },
                        React.createElement("div", null,
                            React.createElement("div", { style: { color: "#042F2E", fontWeight: 700 } }, t.name),
                            React.createElement("div", { style: { color: "#0F766E", fontSize: 11 } },
                                "\u0627\u0644\u062D\u062F \u0627\u0644\u0623\u0642\u0635\u0649: ",
                                t.maxH,
                                " \u0633\u0627\u0639\u0629/\u0623\u0633\u0628\u0648\u0639")),
                        React.createElement("div", { style: { display: "flex", gap: 6, alignItems: "center" } },
                            React.createElement("button", { onClick: () => setModal("offDays-" + t.id), title: "\u062A\u062D\u062F\u064A\u062F \u0623\u064A\u0627\u0645/\u0633\u0627\u0639\u0627\u062A \u0627\u0644\u0625\u062C\u0627\u0632\u0629", style: { background: "#FEF3C7", border: "1px solid #F59E0B", color: "#92400E",
                                    borderRadius: 7, padding: "4px 8px", cursor: "pointer", fontSize: 11, fontWeight: 700 } }, "\uD83C\uDFD6\uFE0F \u0625\u062C\u0627\u0632\u0629"),
                    ...
                    ((t.offDays || []).length > 0 || (t.offSlots || []).length > 0) && (React.createElement("div", { style: { background: "#FEF3C7", border: "1px solid #F59E0B", borderRadius: 8,
                        ...
                        (t.offSlots || []).map((s, i) => (React.createElement("div", { key: i, style: { color: "#92400E", fontSize: 9, marginTop: 2 } },
                            ...
                            ": \u0627\u0644\u062D\u0635\u0635 ",
                            s.periods.join("، ")))))),
                    React.createElement("div", { style: { background: "#F0FDFA", borderRadius: 5, height: 6, overflow: "hidden", marginBottom: 5 } },
                        React.createElement("div", { style: { height: "100%", width: pct + "%", background: pct > 85 ? "#ef4444" : pct > 65 ? "#f59e0b" : "#10b981", borderRadius: 5 } })),
                    React.createElement("div", { style: { color: "#0F766E", fontSize: 11, marginBottom: 10 } },
                        u,
                        " / ",
                        t.maxH,
                        " \u0633\u0627\u0639\u0629 \u0645\u0648\u0632\u0639\u0629"),
            ...
            modal && modal.startsWith("offDays-") && (() => {
                ...
                return (React.createElement("div", { style: { position: "fixed", inset: 0, background: "#00000099", zIndex: 3000,
                    ...
                    React.createElement("div", { style: { background: "#FFFFFF", borderRadius: 18, padding: 24, width: 480,
                            maxHeight: "85vh", overflow: "auto", direction: "rtl", boxShadow: "0 20px 60px #00000033" } },
                        React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 18 } },
                            React.createElement("div", null,
                                React.createElement("h3", { style: { color: "#042F2E", margin: 0, fontSize: 16, fontWeight: 800 } },
                                    "\"\uD83C\uDFD6\uFE0F\" ",
                                    "أوقات إجازة المدرب"),
                                React.createElement("div", { style: { color: "#0F766E", fontSize: 11, marginTop: 3 } }, t.name)),
                            React.createElement("button", { onClick: () => setModal(null), style: { background: "none", border: "none", color: "#0C4A6E", cursor: "pointer", fontSize: 22 } }, "×")),
                        React.createElement("div", { style: { color: "#0C4A6E", fontSize: 12, marginBottom: 16, background: "#FEF3C7",
                        ...
                        DAYS.map(day => {
                            ...
                            return (React.createElement("div", { key: day, style: { marginBottom: 12, border: `2px solid ${isFullDay ? "#F59E0B" : "#99F6E4"}`,
                                ...
                                React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: isFullDay ? 0 : 8 } },
                                    React.createElement("div", { style: { fontWeight: 700, fontSize: 13, color: isFullDay ? "#92400E" : "#134E4A" } }, day),
                                    React.createElement("label", { style: { display: "flex", alignItems: "center", gap: 6, cursor: "pointer" } },
                                        ...
                                        React.createElement("span", { style: { fontSize: 11, fontWeight: 700, color: isFullDay ? "#92400E" : "#0F766E" } }, "يوم كامل"))),
                                !isFullDay && (React.createElement("div", null,
                                    React.createElement("div", { style: { color: "#0F766E", fontSize: 10, marginBottom: 6 } }, "أو اختر حصصاً:"),
                                    React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 5 } }, periods.map(pr => {
                                        const sel = selPeriods.includes(pr.id);
                                        return (React.createElement("button", { key: pr.id, onClick: () => toggleSlot(day, pr.id), style: { padding: "5px 10px", borderRadius: 7, fontSize: 10, fontWeight: 700,
                                            ...
                                            React.createElement("span", { style: { fontSize: 8, display: "block", fontWeight: 400,
                                                    color: sel ? "#FDE68A" : "#0D9488" } }, pr.start)));
                                    }))))));
                        }),
                        (offDays.length > 0 || offSlots.some(s => s.periods.length > 0)) && (React.createElement("div", { style: { background: "#FEF3C7", border: "1px solid #F59E0B", borderRadius: 10,
                        ...
                        React.createElement("div", { style: { display: "flex", gap: 10, marginTop: 16 } },
                            React.createElement("button", { onClick: () => setModal(null), style: { flex: 1, background: "#0C4A6E", color: "#fff", border: "none",
                                    borderRadius: 10, padding: "11px", cursor: "pointer", fontSize: 13, fontWeight: 700 } }, "✅ حفظ"),
                            React.createElement("button", { onClick: () => setTrainers(p => p.map(x => x.id === tid ? Object.assign(Object.assign({}, x), { offDays: [], offSlots: [] }) : x)), style: { padding: "11px 14px", background: "#FEE2E2", color: "#991B1B",
                                    border: "none", borderRadius: 10, cursor: "pointer", fontSize: 12, fontWeight: 700 } }, "مسح الكل")))));
            })(),
            modal === "addTrainer" && (React.createElement(Modal, { title: "\u0625\u0636\u0627\u0641\u0629 \u0645\u062F\u0631\u0628", onClose: () => setModal(null) },
                ...
                React.createElement("div", { style: { marginBottom: 14 } },
                    React.createElement("div", { style: { color: "#0F766E", fontSize: 11, marginBottom: 8 } }, "\u0627\u0644\u062A\u062E\u0635\u0635\u0627\u062A \u0627\u0644\u0645\u0624\u0647\u0644 \u0644\u0647\u0627"),
            ...
            modal === "importTrainersExcel" && (React.createElement(Modal, { title: "\uD83D\uDCCA \u0627\u0633\u062A\u064A\u0631\u0627\u062F \u0627\u0644\u0645\u062F\u0631\u0628\u064A\u0646 \u0645\u0646 Excel", onClose: () => setModal(null), wide: true },
                React.createElement("div", { style: { background: "#FFFFFF", borderRadius: 10, padding: 14, marginBottom: 14 } },
                    React.createElement("div", { style: { color: "#0F766E", fontSize: 12, marginBottom: 10, fontWeight: 700 } }, "\uD83D\uDCCB \u062A\u0639\u0644\u064A\u0645\u0627\u062A \u0627\u0644\u0627\u0633\u062A\u064A\u0631\u0627\u062F"),
                    React.createElement("div", { style: { color: "#0F766E", fontSize: 11, lineHeight: 2 } },
                ...
                React.createElement("div", { style: { overflowX: "auto", marginBottom: 14 } },
                    React.createElement("table", { style: { borderCollapse: "collapse", fontSize: 11, width: "100%" } },
                        React.createElement("thead", null,
                            React.createElement("tr", { style: { background: "#A5F3FC" } }, ["العمود", "الحقل", "مثال", "إلزامي؟"].map(h => (React.createElement("th", { key: h, style: { color: "#0E7490", padding: "6px 10px", border: "1px solid #1e2d45", textAlign: "center" } }, h))))),
                        React.createElement("tbody", null, [
                            ...
                            React.createElement("td", { style: { padding: "5px 10px", border: "1px solid #1e2d45", color: "#134E4A" } }, field),
                            React.createElement("td", { style: { padding: "5px 10px", border: "1px solid #1e2d45", color: "#0F766E", fontFamily: "monospace" } }, ex),
                            React.createElement("td", { style: { padding: "5px 10px", border: "1px solid #1e2d45", textAlign: "center", color: req.includes("✅") ? "#10b981" : "#0F766E" } }, req))))))),
                React.createElement("div", { style: { marginBottom: 14 } },
                    React.createElement("div", { style: { color: "#0F766E", fontSize: 11, marginBottom: 8 } }, "\uD83D\uDCC1 \u0631\u0641\u0639 \u0645\u0644\u0641 Excel \u0623\u0648 CSV:"),
                    React.createElement("input", { type: "file", accept: ".xlsx,.xls,.csv", onChange: async (e) => {
                            ...
                            if (name.endsWith(".csv")) {
                                reader.onload = ev => {
                                    ...
                                    // skip header rows (first 6 rows based on template)
                                    ...
                                    const imported = dataLines.map(line => {
                                        ...
                                        return { id: uid(), name: cols[0], specs, maxH: +cols[6] || 18 };
                                    }).filter(Boolean);
                                    if (imported.length) {
                                        ...
                                        alert("❌ لم يتم العثور على بيانات. تأكد من تعبئة الملف ابتداءً من الصف 7.");
                                };
                                reader.readAsText(file, "UTF-8");
                            }
                            else {
                                // xlsx — read as text using SheetJS via dynamic import fallback
                                reader.onload = ev => {
                                    try {
                                        // Parse CSV-like from ArrayBuffer using basic approach
                                        const text = new TextDecoder("utf-8").decode(new Uint8Array(ev.target.result));
                                        alert("لقراءة xlsx مباشرة ارفع الملف بصيغة CSV.\nاحفظ ملف Excel كـ CSV ثم ارفعه.");
                                    }
                                    catch (err) {
                                ...
                                // Better: parse CSV saved from Excel
                                alert("💡 نصيحة: احفظ ملف Excel بصيغة CSV (ملف ← حفظ باسم ← CSV) ثم ارفعه هنا للاستيراد المباشر.");
                            }
                        }, style: { display: "block", width: "100%", background: "#FFFFFF", border: "2px dashed #1e3a5f",
                            borderRadius: 10, padding: "20px", color: "#0F766E", fontSize: 12, cursor: "pointer", boxSizing: "border-box" } })),
                React.createElement("div", { style: { marginBottom: 14 } },
                    React.createElement("div", { style: { color: "#0F766E", fontSize: 11, marginBottom: 6 } }, "\u0623\u0648 \u0627\u0644\u0635\u0642 \u0645\u062D\u062A\u0648\u0649 CSV \u0645\u0628\u0627\u0634\u0631\u0629 (\u0645\u0646 Excel: \u0646\u0633\u062E \u2190 \u0644\u0635\u0642 \u0647\u0646\u0627):"),
                    React.createElement("textarea", { id: "trainer-csv-input", rows: 5, placeholder: "أ. محمد العمري,1001,بكالوريوس,net,gen,,18,email@edu.sa,\nأ. سارة الزهراني,1002,ماجستير,auto,gen,,16,,", style: { width: "100%", background: "#FFFFFF", border: "1px solid #1e3a5f", borderRadius: 8,
                ...
                React.createElement("div", { style: { display: "flex", gap: 10 } },
                    React.createElement("button", { onClick: () => {
                            ...
                            const imported = lines.map(line => {
                                ...
                                if (!cols[0])
                                    return null;
                                const specs = [cols[3], cols[4], cols[5]].filter(s => ["net", "auto", "gen"].includes(s));
                                const maxH = +cols[6] || 18;
                                return { id: uid(), name: cols[0], specs, maxH };
                            }).filter(Boolean);
                            if (!imported.length) {
                                alert("❌ لا توجد بيانات صحيحة.");
                                return;
                            }
                            setTrainers(p => [...p, ...imported]);
                            setModal(null);
                    ...
                    React.createElement("button", { onClick: () => setModal(null), style: { flex: 1, background: "transparent", color: "#0F766E", border: "1px solid #334155",
                            borderRadius: 9, padding: "10px", cursor: "pointer", fontSize: 13 } }, "\u0625\u0644\u063A\u0627\u0621"))))));
    };
    // ── HALLS TAB ─────────────────────────────────────────────
    const HallsTab = () => {
        ...
        return (React.createElement("div", null,
            React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 18 } },
                React.createElement("h2", { style: { color: "#042F2E", margin: 0, fontSize: 18 } }, "\u0627\u0644\u0642\u0627\u0639\u0627\u062A \u0648\u0627\u0644\u0645\u062E\u062A\u0628\u0631\u0627\u062A \u0648\u0627\u0644\u0648\u0631\u0634"),
                React.createElement(Btn, { onClick: () => setModal("addHall"), bg: "#10b981" }, "+ \u0625\u0636\u0627\u0641\u0629")),
            React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(240px,1fr))", gap: 13 } }, halls.map(h => (React.createElement("div", { key: h.id, style: { background: "#FFFFFF", border: "1px solid #1e2d45", borderRadius: 13, padding: 17 } },
                React.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: 8 } },
                    React.createElement("div", null,
                        React.createElement("div", { style: { color: "#042F2E", fontWeight: 700 } }, h.name),
                        React.createElement("div", { style: { color: "#0F766E", fontSize: 11 } },
                            "\u0627\u0644\u0633\u0639\u0629: ",
                            h.cap,
                            " \u0645\u062A\u062F\u0631\u0628")),
            ...
            modal === "addHall" && (React.createElement(Modal, { title: "\u0625\u0636\u0627\u0641\u0629 \u0642\u0627\u0639\u0629 / \u0645\u062E\u062A\u0628\u0631 / \u0648\u0631\u0634\u0629", onClose: () => setModal(null) },
                ...
                React.createElement("div", { style: { marginBottom: 14 } },
                    React.createElement("div", { style: { color: "#0F766E", fontSize: 11, marginBottom: 8 } }, "\u062A\u062E\u0635\u064A\u0635 \u0627\u0644\u062A\u062E\u0635\u0635"),
    ...
    const TraineesTab = () => {
        ...
        return (React.createElement("div", null,
            React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 18 } },
                React.createElement("h2", { style: { color: "#042F2E", margin: 0, fontSize: 18 } }, "\u0627\u0644\u0645\u062A\u062F\u0631\u0628\u0648\u0646"),
                React.createElement("div", { style: { display: "flex", gap: 8 } },
                    React.createElement(Btn, { onClick: () => setModal("import"), bg: "#99F6E4", outline: true, sm: true }, "\uD83D\uDCE5 \u0627\u0633\u062A\u064A\u0631\u0627\u062F CSV"),
            ...
            React.createElement("div", { style: { display: "flex", gap: 8, marginBottom: 14, flexWrap: "wrap" } },
                SPECIALIZATIONS.filter(s => !s.shared).map(s => (React.createElement("button", { key: s.id, onClick: () => setLs(s.id), style: { padding: "6px 14px", borderRadius: 8, border: `1px solid ${s.color}55`,
                        background: ls === s.id ? s.color : "transparent", color: ls === s.id ? "#fff" : s.color, cursor: "pointer", fontSize: 12, fontWeight: 600 } }, s.name))),
                React.createElement("div", { style: { marginRight: "auto", display: "flex", gap: 5 } }, [1, 2, 3, 4, 5].map(l => (React.createElement("button", { key: l, onClick: () => setLl(l), style: { padding: "6px 12px", borderRadius: 8, border: "1px solid #2a3a55",
                        background: ll === l ? "#99F6E4" : "transparent", color: ll === l ? "#134E4A" : "#0F766E", cursor: "pointer", fontSize: 12 } },
                    "\u0645",
                    l))))),
            React.createElement("div", { style: { color: "#0F766E", fontSize: 12, marginBottom: 12 } },
                "\u0627\u0644\u0639\u062F\u062F: ",
                React.createElement("strong", { style: { color: "#134E4A" } }, filt.length)),
            filt.length === 0
                ? React.createElement("div", { style: { textAlign: "center", padding: 40, border: "1px dashed #1e2d45", borderRadius: 12, color: "#99F6E4" } }, "\u0644\u0627 \u064A\u0648\u062C\u062F \u0645\u062A\u062F\u0631\u0628\u0648\u0646")
                : (React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(270px,1fr))", gap: 12 } }, filt.map(t => (React.createElement("div", { key: t._id, style: { background: "#FFFFFF", border: "1px solid #1e2d45", borderRadius: 12, padding: 15 } },
                    React.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: 7 } },
                        React.createElement("div", null,
                            React.createElement("div", { style: { color: "#042F2E", fontWeight: 700 } }, t.name),
                            React.createElement("div", { style: { color: "#0F766E", fontSize: 11 } }, t.sid)),
            ...
            modal === "addTrainee" && (React.createElement(Modal, { title: "\u0625\u0636\u0627\u0641\u0629 \u0645\u062A\u062F\u0631\u0628", onClose: () => setModal(null) },
                ...
                React.createElement("div", { style: { marginBottom: 14 } },
                    React.createElement("div", { style: { color: "#0F766E", fontSize: 11, marginBottom: 7 } }, "\u0627\u0644\u0645\u0642\u0631\u0631\u0627\u062A \u0627\u0644\u0645\u062A\u0628\u0642\u064A\u0629"),
                    React.createElement("div", { style: { maxHeight: 190, overflow: "auto", background: "#FFFFFF", borderRadius: 8, padding: 10 } }, av.map(c => (React.createElement("label", { key: c.id, style: { display: "flex", alignItems: "center", gap: 7, marginBottom: 7, cursor: "pointer" } },
                        ...
                        React.createElement("span", { style: { color: "#134E4A", fontSize: 11 } },
                            c.name,
                            " \u2014 \u0645",
                            c.level)))))),
            ...
            modal === "import" && (React.createElement(Modal, { title: "\u0627\u0633\u062A\u064A\u0631\u0627\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u062A\u062F\u0631\u0628\u064A\u0646", onClose: () => setModal(null), wide: true },
                React.createElement("div", { style: { background: "#FFFFFF", borderRadius: 8, padding: 11, marginBottom: 11, fontSize: 10, color: "#0F766E", fontFamily: "monospace", lineHeight: 1.9 } },
                    "\u0627\u0644\u0635\u064A\u063A\u0629: \u0627\u0644\u0627\u0633\u0645,\u0631\u0642\u0645 \u0627\u0644\u0645\u0644\u0641,\u0627\u0644\u062A\u062E\u0635\u0635(net/auto),\u0627\u0644\u0641\u0635\u0644,\u0623\u0643\u0648\u0627\u062F \u0627\u0644\u0645\u0642\u0631\u0631\u0627\u062A(\u0645\u0641\u0635\u0648\u0644\u0629 \u0628\u0640 ;)",
                    React.createElement("br", null),
                    "\u0645\u062B\u0627\u0644:",
                    React.createElement("br", null),
                    "\u0645\u062D\u0645\u062F \u0627\u0644\u0639\u0645\u0631\u064A,1001,net,2,ICMT 102;ISUP 151;ENGL 102"),
                React.createElement("textarea", { value: importTxt, onChange: e => setImportTxt(e.target.value), rows: 7, style: { width: "100%", background: "#FFFFFF", border: "1px solid #1e3a5f", borderRadius: 8,
                        padding: 11, color: "#134E4A", fontSize: 12, fontFamily: "monospace", boxSizing: "border-box", direction: "ltr" } }),
                React.createElement("div", { style: { color: "#0F766E", fontSize: 12, margin: "8px 0" } },
                    "\u0633\u064A\u062A\u0645 \u0627\u0633\u062A\u064A\u0631\u0627\u062F ",
    ...
    const ScheduleTab = () => {
        ...
        return (React.createElement("div", null,
            warn && (React.createElement("div", { style: { background: "#FEF2F2", border: "1px solid #EF4444", borderRadius: 10, padding: "10px 16px",
                ...
                React.createElement("div", null,
                    React.createElement("div", { style: { fontWeight: 700, marginBottom: 2 } }, "\u062A\u0639\u0627\u0631\u0636 \u0641\u064A \u0627\u0644\u062C\u062F\u0648\u0644"),
                    React.createElement("div", { style: { fontSize: 12 } }, warn)),
                React.createElement("button", { onClick: () => setWarn(null), style: { marginRight: "auto", background: "none", border: "none", color: "#ef4444", cursor: "pointer", fontSize: 18, flexShrink: 0 } }, "\u00D7"))),
            React.createElement("div", { style: { display: "flex", gap: 10, marginBottom: 14, alignItems: "center", flexWrap: "wrap" } },
                React.createElement("h2", { style: { color: "#042F2E", margin: 0, fontSize: 18 } }, "\u0625\u0639\u062F\u0627\u062F \u0627\u0644\u062C\u062F\u0627\u0648\u0644"),
                React.createElement(Btn, { onClick: () => setModal("periodSettings"), bg: "#99F6E4", outline: true, sm: true }, "\u2699\uFE0F \u0623\u0648\u0642\u0627\u062A \u0627\u0644\u062D\u0635\u0635"),
                React.createElement(Btn, { onClick: () => setModal("assignCourses"), bg: "#8b5cf6", outline: true, sm: true }, "\uD83D\uDCCB \u062A\u062E\u0635\u064A\u0635 \u0627\u0644\u0645\u062F\u0631\u0628\u064A\u0646"),
                React.createElement("div", { style: { display: "flex", gap: 8, marginRight: "auto" } }, SPECIALIZATIONS.filter(s => !s.shared).map(s => (React.createElement("button", { key: s.id, onClick: () => { setSelSpec(s.id); setSelGroup(null); }, style: { padding: "6px 14px", borderRadius: 8, border: `1px solid ${s.color}55`,
                ...
                React.createElement("div", { style: { display: "flex", gap: 5 } }, [1, 2, 3, 4, 5].map(l => (React.createElement("button", { key: l, onClick: () => { setSelLv(l); setSelGroup(null); }, style: { padding: "6px 12px", borderRadius: 8, border: "1px solid #2a3a55",
                        background: selLv === l ? "#99F6E4" : "transparent", color: selLv === l ? "#134E4A" : "#0F766E", cursor: "pointer", fontSize: 12 } },
                    "\u0645",
                    l))))),
            React.createElement("div", { style: { background: "#FFFFFF", border: "1px solid #1e2d45", borderRadius: 12, padding: "10px 14px", marginBottom: 14 } },
                React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" } },
                    React.createElement("span", { style: { color: "#0F766E", fontSize: 12, fontWeight: 700, whiteSpace: "nowrap" } }, "\uD83D\uDCCB \u0627\u0644\u0631\u0632\u0645:"),
                    gs.map(g => (React.createElement("div", { key: g.id, style: { display: "flex", alignItems: "center", gap: 0 } },
                        editingName === g.id ? (React.createElement("input", { autoFocus: true, value: g.name, onChange: e => renameGroup(selSpec, selLv, g.id, e.target.value), onBlur: () => setEditingName(null), onKeyDown: e => e.key === "Enter" && setEditingName(null), style: { background: "#FFFFFF", border: `1px solid ${col}`, borderRadius: "7px 0 0 7px",
                                padding: "5px 10px", color: "#042F2E", fontSize: 12, width: 100 } })) : (React.createElement("button", { onClick: () => { setSelGroup(g.id); }, onDoubleClick: () => setEditingName(g.id), title: "\u0627\u0636\u063A\u0637 \u0645\u0631\u062A\u064A\u0646 \u0644\u0644\u062A\u0639\u062F\u064A\u0644", style: { padding: "5px 12px", borderRadius: gs.length > 1 ? "7px 0 0 7px" : 8,
                            ...
                            g.name,
                            React.createElement("span", { style: { color: "#0F766E", fontSize: 10, marginRight: 4 } },
                                "(",
                        ...
                        gs.length > 1 && (React.createElement("button", { onClick: () => { if (window.confirm(`حذف "${g.name}"؟`))
                                ...
                                borderRight: "none", background: "#F0FDFA", color: "#ef4444", cursor: "pointer", fontSize: 12, lineHeight: 1 } }, "\u00D7"))))),
                    React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 0, marginRight: 4 } },
                        ...
                        React.createElement("button", { onClick: () => {
                                ...
                                background: "#A5F3FC", color: "#0E7490", cursor: "pointer", fontSize: 12, fontWeight: 700 } }, "+ \u0631\u0632\u0645\u0629")),
                    gs.length === 0 && (React.createElement("span", { style: { color: "#0F766E", fontSize: 11 } }, "\u0644\u0627 \u062A\u0648\u062C\u062F \u0631\u0632\u0645 \u2014 \u0623\u0636\u0641 \u0631\u0632\u0645\u0629 \u0644\u062A\u0628\u062F\u0623")),
                    curGid && sched.length > 0 && (React.createElement("button", { onClick: () => setSched(selSpec, selLv, curGid, []), style: { marginRight: "auto", padding: "5px 12px", borderRadius: 8, border: "1px solid #ef444455",
                            background: "none", color: "#ef4444", cursor: "pointer", fontSize: 11 } }, "\u0645\u0633\u062D \u062C\u062F\u0648\u0644 \u0647\u0630\u0647 \u0627\u0644\u0631\u0632\u0645\u0629"))),
                gs.length > 0 && (React.createElement("div", { style: { color: "#0C4A6E", fontSize: 10, marginTop: 6 } }, "\uD83D\uDCA1 \u0627\u0636\u063A\u0637 \u0645\u0631\u062A\u064A\u0646 \u0639\u0644\u0649 \u0627\u0633\u0645 \u0627\u0644\u0631\u0632\u0645\u0629 \u0644\u062A\u0639\u062F\u064A\u0644\u0647")),
                curGid && coursesInLevel.length > 0 && (() => {
                    ...
                    if (issues.every(x => !x.hasAny))
                        return null;
                    return (React.createElement("div", { style: { marginTop: 8, background: "#F0FDFA", border: "1px solid #E2E8F0", borderRadius: 10, padding: "10px 14px" } },
                        React.createElement("div", { style: { display: "flex", gap: 8, flexWrap: "wrap", alignItems: "flex-start" } },
                            React.createElement("span", { style: { color: "#0F766E", fontSize: 11, fontWeight: 700, whiteSpace: "nowrap" } }, "\uD83D\uDCCA \u0645\u0644\u062E\u0635 \u0627\u0644\u0633\u0627\u0639\u0627\u062A:"),
                            ...
                            zeroCourses.length > 0 && (React.createElement("span", { style: { color: "#0F766E", fontSize: 11 } },
                                "\u2B1C \u0644\u0645 \u064A\u064F\u0648\u0632\u064E\u0651\u0639 (",
                                zeroCourses.length,
                                "):",
                                zeroCourses.map(x => (React.createElement("span", { key: x.c.id, style: { background: "#F0FDFA", color: "#0F766E", borderRadius: 4, padding: "1px 6px", margin: "0 3px", fontSize: 10 } }, x.c.code))))))));
                })()),
            gs.length === 0 && (React.createElement("div", { style: { textAlign: "center", padding: "40px 20px", border: "1px dashed #1e2d45", borderRadius: 12, color: "#99F6E4", marginBottom: 14 } },
            ...
            curGid && (React.createElement("div", { style: { display: "grid", gridTemplateColumns: "200px 1fr", gap: 14 } },
                React.createElement("div", { style: { background: "#F0FDFA", border: "1px solid #E2E8F0", borderRadius: 13, padding: 10, maxHeight: 720, overflowY: "auto" } },
                    React.createElement("div", { style: { color: "#0F766E", fontSize: 11, fontWeight: 700, marginBottom: 8 } },
                        "\uD83D\uDDC2 \u0645\u0642\u0631\u0631\u0627\u062A \u0627\u0644\u0641\u0635\u0644 ",
                        selLv),
                    coursesInLevel.length === 0
                        ? React.createElement("div", { style: { color: "#0F766E", fontSize: 11, textAlign: "center" } }, "\u0644\u0627 \u062A\u0648\u062C\u062F \u0645\u0642\u0631\u0631\u0627\u062A")
                        : coursesInLevel.map(c => {
                            ...
                            return (React.createElement("div", { key: c.id, draggable: true, onDragStart: e => e.dataTransfer.setData("courseId", c.id), style: { background: anyOver ? "#FEF2F2" : allDone ? "#F0FDF4" : cc + "12",
                                ...
                                React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" } },
                                    ...
                                    React.createElement("span", { style: { background: anyOver ? "#EF4444" : allDone ? "#10B981" : "#99F6E4",
                                        ...
                                        c.CTH,
                                        "\u0633")),
                                React.createElement("div", { style: { color: "#134E4A", fontSize: 10, marginTop: 2, lineHeight: 1.3, marginBottom: 4 } }, c.name),
                                theoryNeeded > 0 && (React.createElement("div", { style: { marginBottom: 3 } },
                                    React.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: 1 } },
                                        React.createElement("span", { style: { fontSize: 8, color: "#0891B2", fontWeight: 600 } }, "\u0646\u0638\u0631\u064A"),
                                        React.createElement("span", { style: { fontSize: 8, color: theoryOver ? "#EF4444" : theoryDone ? "#10B981" : "#0F766E", fontWeight: 700 } },
                                            scheduledTheoryH,
                                            "/",
                                            theoryNeeded,
                                            "\u0633")),
                                    React.createElement("div", { style: { background: "#CFFAFE", borderRadius: 3, height: 5, overflow: "hidden" } },
                                ...
                                practNeeded > 0 && (React.createElement("div", { style: { marginBottom: 4 } },
                                    React.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: 1 } },
                                        ...
                                        React.createElement("span", { style: { fontSize: 8, color: practOver ? "#EF4444" : practDone ? "#10B981" : "#0F766E", fontWeight: 700 } },
                                            scheduledPractH,
                                            "/",
                                            practNeeded,
                                            "\u0633")),
                                ...
                                !allDone && !anyOver && sessions.length > 0 && (React.createElement("div", { style: { color: "#0F766E", fontSize: 9 } },
                                ...
                                (tTr || pTr) && (React.createElement("div", { style: { fontSize: 9, color: "#0C4A6E", lineHeight: 1.7, marginTop: 3, borderTop: "1px solid #E2E8F0", paddingTop: 3 } },
                    ...
                    React.createElement("div", { style: { marginTop: 10, padding: 8, background: "#E0FDF9", border: "1px solid #BFDBFE", borderRadius: 8, fontSize: 10, color: "#1E40AF", lineHeight: 2 } },
                ...
                React.createElement("div", { style: { overflowX: "auto" } },
                    React.createElement("div", { style: { background: "#FFFFFF", border: `1px solid ${col}55`, borderRadius: 13, padding: 10 } },
                        React.createElement("div", { style: { color: "#0F766E", fontSize: 12, fontWeight: 700, marginBottom: 8 } },
                            "\uD83D\uDCC5 ",
                            spName(selSpec),
                            " \u2014 \u0627\u0644\u0641\u0635\u0644 ",
                            selLv,
                            ...
                            React.createElement("span", { style: { color: "#99F6E4", marginRight: 8 } },
                                "(",
                                sched.length,
                                " \u062D\u0635\u0629)")),
                        React.createElement("table", { style: { borderCollapse: "collapse", width: "100%" } },
                            React.createElement("thead", null,
                                React.createElement("tr", null,
                                    React.createElement("th", { style: { background: "#FFFFFF", color: "#0F766E", padding: "7px 8px",
                                    ...
                                    const rowCells = DAYS.map(day => {
                                        ...
                                        const cellConflicts = cell ? (() => {
                                            ...
                                            [cell.theoryTrainerId, cell.practicalTrainerId].filter(Boolean).forEach(tid => {
                                                var _a;
                                                const clash = all.find(x => x.id !== cell.id && x.day === day && x.period === pr.id && (x.theoryTrainerId === tid || x.practicalTrainerId === tid));
                                                if (clash) {
                                                    msgs.push("تعارض مدرب: " + ((_a = trainers.find(t => t.id === tid)) === null || _a === void 0 ? void 0 : _a.name));
                                                }
                                            });
                                            if (cell.hallId) {
                                                const clash = all.find(x => x.id !== cell.id && x.day === day && x.period === pr.id && x.hallId === cell.hallId);
                                                if (clash) {
                                                    msgs.push("تعارض قاعة: " + ((_a = halls.find(h => h.id === cell.hallId)) === null || _a === void 0 ? void 0 : _a.name));
                                                }
                                            }
                                            return msgs;
                                        })() : [];
                                        ...
                                        return (React.createElement("td", { key: day, rowSpan: sessionH, onDragOver: e => e.preventDefault(), onDrop: e => { setSelGroup(curGid); handleDrop(e, day, pr.id, selSpec, selLv, curGid); }, style: {
                                            ...
                                            React.createElement(SchedCell, { cell: cell, courses: courses, trainers: trainers, halls: halls, spColor: spColor, mainSpec: selSpec, sched: sched, periods: periods, conflicts: cellConflicts, sharedWith: getSharedWith(cell, selSpec, selLv, curGid), allGroups: allAvailGroups(cell, selSpec, selLv, curGid), onAddShared: (keys) => addSharedCopies(cell, selSpec, selLv, curGid, keys), onRemove: () => setSched(selSpec, selLv, curGid, p => p.filter(s => s.id !== cell.id)), onUpdate: upd => handleCellUpdate(selSpec, selLv, curGid, cell.id, upd) })))));
                                    });
                                    return (React.createElement(React.Fragment, null,
                                        React.createElement("tr", { key: pr.id },
                                            React.createElement("td", { style: { background: "#E0FDF9", padding: "4px 6px", border: "1px solid #E2E8F0", verticalAlign: "middle", minWidth: 88 } },
                                                React.createElement("div", { style: { textAlign: "center" } },
                                                    React.createElement("div", { style: { color: "#0E7490", fontWeight: 700, fontSize: 12 } },
                                                        "\u0627\u0644\u062D\u0635\u0629 ",
                                                        pr.label),
                                                    React.createElement("div", { style: { color: "#0F766E", fontSize: 9, direction: "ltr" } }, pr.start),
                                                    React.createElement("div", { style: { color: "#0F766E", fontSize: 9, direction: "ltr" } }, pr.end))),
                                            rowCells),
    ...
    const StatsTab = () => {
        ...
        const trainerLoad = trainers.map(t => {
            const cells = allCells().filter(c => c.theoryTrainerId === t.id || c.practicalTrainerId === t.id);
            const thH = cells.filter(c => c.theoryTrainerId === t.id).reduce((a, s) => a + (s.sessionHours || 1), 0);
            const prH = cells.filter(c => c.practicalTrainerId === t.id).reduce((a, s) => a + (s.sessionHours || 1), 0);
            const total = cells.reduce((a, s) => a + (s.sessionHours || 1), 0);
        ...
        const StatCard = ({ icon, label, value, sub, color, onClick, active }) => (React.createElement("div", { onClick: onClick, style: { background: active ? color + "22" : "#FFFFFF", border: `2px solid ${active ? color : color + "44"}`,
            ...
            React.createElement("div", { style: { color: "#0F766E", fontSize: 12, fontWeight: 600 } }, label),
            sub && React.createElement("div", { style: { color: "#0F766E", fontSize: 11, marginTop: 2 } }, sub)));
        // ── Progress bar ──────────────────────────────────────────
        const ProgressBar = ({ value, max, color, height = 8 }) => (React.createElement("div", { style: { background: "#99F6E4", borderRadius: 99, height, overflow: "hidden" } },
            React.createElement("div", { style: { height: "100%", borderRadius: 99, width: Math.min(100, max > 0 ? value / max * 100 : 0) + "%",
                    background: color, transition: "width 0.4s" } })));
        const StatusBadge = ({ done, over, partial, empty }) => {
            if (over)
                return React.createElement("span", { style: { background: "#FEE2E2", color: "#991B1B", borderRadius: 5, padding: "2px 8px", fontSize: 10, fontWeight: 700 } }, "\uD83D\uDEAB \u062A\u062C\u0627\u0648\u0632");
            if (done)
                return React.createElement("span", { style: { background: "#D1FAE5", color: "#065F46", borderRadius: 5, padding: "2px 8px", fontSize: 10, fontWeight: 700 } }, "\u2705 \u0645\u0643\u062A\u0645\u0644");
            if (partial)
                return React.createElement("span", { style: { background: "#FEF3C7", color: "#92400E", borderRadius: 5, padding: "2px 8px", fontSize: 10, fontWeight: 700 } }, "\u26A0\uFE0F \u0646\u0627\u0642\u0635");
            return React.createElement("span", { style: { background: "#F0FDFA", color: "#0F766E", borderRadius: 5, padding: "2px 8px", fontSize: 10, fontWeight: 700 } }, "\u2B1C \u0644\u0645 \u064A\u064F\u0648\u0632\u064E\u0651\u0639");
        };
        return (React.createElement("div", null,
            React.createElement("div", { style: { display: "flex", gap: 8, marginBottom: 20, flexWrap: "wrap", alignItems: "center" } },
                React.createElement("h2", { style: { color: "#042F2E", margin: 0, fontSize: 18, marginLeft: "auto" } }, "\uD83D\uDCC8 \u0627\u0644\u0625\u062D\u0635\u0627\u0626\u064A\u0627\u062A \u0648\u0627\u0644\u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u0646\u0647\u0627\u0626\u064A"),
                [{ id: "all", name: "الكل", color: "#0F766E" }, ...SPECIALIZATIONS.filter(s => !s.shared)].map(s => (React.createElement("button", { key: s.id, onClick: () => setFilterSpec(s.id), style: { padding: "6px 14px", borderRadius: 8, border: `1px solid ${s.color}55`,
            ...
            React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(140px,1fr))", gap: 12, marginBottom: 20 } },
                ...
                React.createElement(StatCard, { icon: "\u2B1C", label: "\u0644\u0645 \u062A\u064F\u0648\u0632\u064E\u0651\u0639", value: emptyCourses, color: "#0F766E", sub: "\u0644\u0645 \u062A\u064F\u0636\u064E\u0641 \u0644\u0644\u062C\u062F\u0648\u0644" })),
            React.createElement("div", { style: { background: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: 14, padding: 18, marginBottom: 20 } },
                React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 } },
                    React.createElement("div", { style: { color: "#042F2E", fontWeight: 700, fontSize: 14 } }, "\u0646\u0633\u0628\u0629 \u0627\u0643\u062A\u0645\u0627\u0644 \u0627\u0644\u062C\u062F\u0627\u0648\u0644"),
                ...
                React.createElement("div", { style: { display: "flex", gap: 16, marginTop: 10, flexWrap: "wrap" } }, [
                    ...
                    React.createElement("span", { style: { color: "#0F766E", fontSize: 12 } },
                        x.label,
                        ": ",
                        React.createElement("strong", null, x.v))))))),
            React.createElement("div", { style: { marginBottom: 20 } },
                React.createElement("h3", { style: { color: "#042F2E", fontSize: 14, fontWeight: 700, marginBottom: 12 } }, "\uD83D\uDCCB \u062A\u0641\u0627\u0635\u064A\u0644 \u0627\u0644\u0645\u0642\u0631\u0631\u0627\u062A \u0644\u0643\u0644 \u0631\u0632\u0645\u0629"),
                stats.map(({ specId, lv, g, courseResults }) => {
                    ...
                    return (React.createElement("div", { key: `${specId}-${lv}-${g.id}`, style: { background: "#FFFFFF", border: `1px solid ${sc}33`, borderRadius: 12, padding: 16, marginBottom: 12 } },
                        React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 } },
                            React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8 } },
                                React.createElement(Badge, { color: sc }, spName(specId)),
                                React.createElement("span", { style: { color: "#0F766E", fontWeight: 700 } },
                                    "\u0627\u0644\u0641\u0635\u0644 ",
                                    lv),
                        ...
                        React.createElement("div", { style: { marginTop: 10, display: "flex", flexWrap: "wrap", gap: 6 } }, courseResults.map(({ c, scheduledTh, scheduledPr, theoryNeeded, practNeeded, done, over, partial, empty }) => (React.createElement("div", { key: c.id, style: {
                            ...
                            React.createElement("div", { style: { color: "#0F766E", fontSize: 9, marginBottom: 4 } }, c.name),
                ...
                stats.length === 0 && (React.createElement("div", { style: { textAlign: "center", padding: "30px", color: "#0F766E", border: "1px dashed #E2E8F0", borderRadius: 12 } }, "\u0644\u0627 \u062A\u0648\u062C\u062F \u0631\u0632\u0645 \u0628\u0639\u062F \u2014 \u0623\u0636\u0641 \u0631\u0632\u0645\u0629 \u0648\u0627\u0628\u062F\u0623 \u0628\u062A\u0648\u0632\u064A\u0639 \u0627\u0644\u0645\u0642\u0631\u0631\u0627\u062A"))),
            React.createElement("div", { style: { background: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: 14, padding: 18, marginBottom: 20 } },
                React.createElement("h3", { style: { color: "#042F2E", fontSize: 14, fontWeight: 700, marginBottom: 14 } }, "\uD83D\uDC68\u200D\uD83C\uDFEB \u062D\u0645\u0644 \u0627\u0644\u0645\u062F\u0631\u0628\u064A\u0646"),
                trainerLoad.length === 0
                    ? React.createElement("div", { style: { color: "#0F766E", fontSize: 13 } }, "\u0644\u0627 \u064A\u0648\u062C\u062F \u0645\u062F\u0631\u0628\u0648\u0646")
                    : trainerLoad.map(({ t, thH, prH, total, pct, over }) => (React.createElement("div", { key: t.id, style: { marginBottom: 14, paddingBottom: 14, borderBottom: "1px solid #F1F5F9" } },
                        React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 5 } },
                            React.createElement("div", null,
                                React.createElement("span", { style: { color: "#042F2E", fontWeight: 700, fontSize: 13 } }, t.name),
                                React.createElement("span", { style: { color: "#0F766E", fontSize: 11, marginRight: 8 } },
                                    "(",
                                    total,
                                    "/",
                                    t.maxH,
                        ...
                        over && React.createElement("div", { style: { color: "#EF4444", fontSize: 11, marginTop: 4 } },
                            ...
                            " \u0633\u0627\u0639\u0629"))))),
            React.createElement("div", { style: { background: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: 14, padding: 18, marginBottom: 20 } },
                React.createElement("h3", { style: { color: "#042F2E", fontSize: 14, fontWeight: 700, marginBottom: 14 } }, "\uD83C\uDFDB \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0627\u0644\u0642\u0627\u0639\u0627\u062A"),
                hallUsage.map(({ h, usedPeriods, totalPeriods, pct }) => (React.createElement("div", { key: h.id, style: { marginBottom: 12 } },
                    React.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: 4 } },
                        React.createElement("div", null,
                            React.createElement("span", { style: { color: "#042F2E", fontWeight: 600 } }, h.name),
                            React.createElement(Badge, { color: h.type === "theory" ? "#0891B2" : "#10B981", style: { marginRight: 6 } }, h.type === "theory" ? "نظري" : "عملي"),
                            React.createElement("span", { style: { color: "#0F766E", fontSize: 11, marginRight: 6 } },
                                "\u0633\u0639\u0629: ",
                                h.cap,
                                " | \u0645\u062D\u062C\u0648\u0632: ",
                                usedPeriods,
                        ...
                        React.createElement("span", { style: { color: pct > 80 ? "#EF4444" : pct > 50 ? "#F59E0B" : "#10B981", fontWeight: 700 } },
                            pct,
                            "%")),
                    React.createElement(ProgressBar, { value: usedPeriods, max: totalPeriods, color: pct > 80 ? "#EF4444" : pct > 50 ? "#F59E0B" : "#0891B2" }))))),
            React.createElement("div", { style: { background: "linear-gradient(135deg,#1E3A5F,#1D4ED8)", borderRadius: 14, padding: 20, marginBottom: 20 } },
                ...
                ].map(item => (React.createElement("div", { key: item.l, style: { background: "#ffffff18", borderRadius: 10, padding: "10px 14px",
                ...
                React.createElement("div", { style: { marginTop: 16, padding: "10px 14px", background: "#ffffff15", borderRadius: 10, color: "#0C4A6E", fontSize: 12, lineHeight: 2 } }, completePct === 100 && overCourses === 0 && trainerLoad.filter(x => x.over).length === 0
    ...
    const ViewTab = () => {
        ...
        const allC = Object.entries(scheds[viewSpec] || {}).flatMap(([lv, lvGroups]) => Object.entries(lvGroups || {}).flatMap(([gid, cells]) => {
            ...
            return cells.map(c => (Object.assign(Object.assign({}, c), { level: +lv, gid, gName })));
        }));
        const GridTable = ({ cells, color }) => {
            ...
            return (React.createElement("div", { style: { overflowX: "auto", background: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: 11, padding: 9 } },
                React.createElement("table", { style: { borderCollapse: "collapse", fontSize: 11, width: "100%" } },
                    React.createElement("thead", null,
                        React.createElement("tr", null,
                            React.createElement("th", { style: { background: "#F0FDFA", color: "#0F766E", padding: "6px 8px", border: "1px solid #E2E8F0", minWidth: 88, fontSize: 10 } }, "\u0627\u0644\u062D\u0635\u0629 / \u0627\u0644\u0648\u0642\u062A"),
                    ...
                    React.createElement("tbody", null, periods.map(pr => {
                        const rowCells = DAYS.map(day => {
                            ...
                            return (React.createElement("td", { key: day, rowSpan: sessionH, style: { border: `3px solid ${crs ? (isTheory ? "#A5F3FC" : "#6EE7B7") : "#99F6E4"}`,
                                    background: crs ? (isTheory ? "#ECFEFF" : "#ECFDF5") : "#F0FDFA",
                                    padding: "8px 10px", verticalAlign: "top" } }, crs && (React.createElement("div", null,
                                React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 3 } },
                                    React.createElement("span", { style: { background: isTheory ? "#0891B2" : "#10B981", color: "#fff", borderRadius: 5, padding: "2px 7px", fontSize: 9, fontWeight: 700 } }, isTheory ? "📘 نظري" : "🔧 عملي"),
                                    React.createElement("div", { style: { display: "flex", gap: 3 } },
                                        ...
                                        React.createElement("span", { style: { background: isTheory ? "#0E7490" : "#065F46", color: "#fff", borderRadius: 5, padding: "2px 6px", fontSize: 9, fontWeight: 700 } },
                                            sessionH,
                                            "\u0633"))),
                                React.createElement("div", { style: { color: cc, fontWeight: 800, fontFamily: "monospace", fontSize: 10, marginBottom: 1 } }, crs.code),
                                React.createElement("div", { style: { color: "#134E4A", fontSize: 9, lineHeight: 1.4, marginBottom: 4 } }, crs.name),
                                showTr && React.createElement("div", { style: { color: isTheory ? "#0E7490" : "#065F46", fontSize: 9, marginBottom: 2 } },
                                    "\uD83D\uDC68\u200D\uD83C\uDFEB ",
                                    showTr.name),
                                hl && React.createElement("div", { style: { color: "#0F766E", fontSize: 9 } },
                                    "\uD83C\uDFDB ",
                                    hl.name),
                                sessionH > 1 && React.createElement("div", { style: { marginTop: 4, color: isTheory ? "#0891B2" : "#10B981", fontSize: 8, fontWeight: 600, direction: "ltr" } },
                                    pr.start,
                                    " \u2014 ",
                        ...
                        return (React.createElement(React.Fragment, null,
                            React.createElement("tr", { key: pr.id },
                                React.createElement("td", { style: { background: "#E0FDF9", padding: "4px 6px", border: "1px solid #E2E8F0", textAlign: "center", verticalAlign: "middle" } },
                                    React.createElement("div", { style: { color: "#0E7490", fontWeight: 700, fontSize: 11 } },
                                        "\u0627\u0644\u062D\u0635\u0629 ",
                                        pr.label),
                                    React.createElement("div", { style: { color: "#0F766E", fontSize: 9, direction: "ltr" } },
                                        pr.start,
                                        "\u2013",
                                        pr.end)),
                                rowCells),
        ...
        return (React.createElement("div", { id: "print-area" },
            React.createElement("div", { className: "no-print", style: { display: "flex", gap: 10, marginBottom: 18, alignItems: "center", flexWrap: "wrap" } },
                React.createElement("h2", { style: { color: "#042F2E", margin: 0, fontSize: 18 } }, "\u0639\u0631\u0636 \u0627\u0644\u062C\u062F\u0627\u0648\u0644"),
                React.createElement("div", { style: { display: "flex", gap: 7 } }, [{ id: "trainees", l: "جدول المتدربين", i: "👥" }, { id: "trainers", l: "جدول المدربين", i: "👨‍🏫" }, { id: "halls", l: "جدول القاعات", i: "🏛" }].map(m => (React.createElement("button", { key: m.id, onClick: () => setViewMode(m.id), style: { padding: "6px 12px", borderRadius: 8, border: "1px solid #CBD5E1",
                        background: viewMode === m.id ? "#99F6E4" : "transparent", color: viewMode === m.id ? "#134E4A" : "#0F766E", cursor: "pointer", fontSize: 12 } },
                    m.i,
                    " ",
                    m.l)))),
                viewMode !== "halls" && (React.createElement("div", { style: { display: "flex", gap: 7 } }, SPECIALIZATIONS.filter(s => !s.shared).map(s => (React.createElement("button", { key: s.id, onClick: () => setViewSpec(s.id), style: { padding: "6px 12px", borderRadius: 8, border: `1px solid ${s.color}55`,
                        background: viewSpec === s.id ? s.color : "transparent", color: viewSpec === s.id ? "#fff" : s.color, cursor: "pointer", fontSize: 12 } }, s.name))))),
                React.createElement("button", { onClick: () => window.print(), style: { marginRight: "auto", padding: "8px 18px", borderRadius: 10,
            ...
            React.createElement("div", { id: "print-header", style: { display: "none", justifyContent: "space-between",
                ...
                React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 12 } },
                    ...
                    React.createElement("div", { style: { borderRight: "1px solid #ffffff44", paddingRight: 12 } },
                        React.createElement("div", { style: { fontSize: "7pt", color: "#0C4A6E", marginBottom: 2 } }, "\u0627\u0644\u0645\u0624\u0633\u0633\u0629 \u0627\u0644\u0639\u0627\u0645\u0629 \u0644\u0644\u062A\u062F\u0631\u064A\u0628 \u0627\u0644\u062A\u0642\u0646\u064A \u0648\u0627\u0644\u0645\u0647\u0646\u064A"),
                ...
                React.createElement("div", { style: { textAlign: "center" } },
                    ...
                    React.createElement("div", { style: { fontSize: "9pt", color: "#0C4A6E" } },
                        viewMode !== "halls" ? spName(viewSpec) : "جميع القاعات",
                        " \u2014 \u0627\u0644\u0639\u0627\u0645 \u0627\u0644\u062F\u0631\u0627\u0633\u064A \u0661\u0664\u0664\u0667\u0647\u0640")),
                React.createElement("div", { style: { textAlign: "left", fontSize: "9pt", color: "#0C4A6E" } },
                    ...
                    React.createElement("div", { style: { marginTop: 4, color: "#0C4A6E" } }, "\u0645. \u0645\u0639\u0627\u0630 \u0639\u0628\u062F\u0627\u0644\u0644\u0647 \u0627\u0644\u0633\u0644\u0648\u0645"),
                    React.createElement("div", { style: { color: "#0C4A6E" } }, "\u0648\u0643\u064A\u0644 \u0634\u0624\u0648\u0646 \u0627\u0644\u0645\u062F\u0631\u0628\u064A\u0646"))),
            ...
            viewMode === "trainers" && trainers.map(t => {
                ...
                const thH = cells.filter(c => c.theoryTrainerId === t.id).reduce((a, s) => a + (s.sessionHours || 1), 0);
                const prH = cells.filter(c => c.practicalTrainerId === t.id).reduce((a, s) => a + (s.sessionHours || 1), 0);
                return (React.createElement("div", { key: t.id, style: { background: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: 13, padding: 14, marginBottom: 14 } },
                    React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 } },
                        React.createElement("div", { style: { color: "#042F2E", fontWeight: 700, fontSize: 14 } }, t.name),
                        React.createElement("div", { style: { display: "flex", gap: 6 } },
                            React.createElement(Badge, { color: "#0891B2" },
                                "\u0646\u0638\u0631\u064A: ",
                                thH,
                                "\u0633"),
                            React.createElement(Badge, { color: "#10B981" },
                                ...
                                prH,
                                "\u0633"),
                            React.createElement(Badge, { color: thH + prH > t.maxH ? "#EF4444" : "#F59E0B" },
                                "\u0625\u062C\u0645\u0627\u0644\u064A: ",
                                thH + prH,
                                "/",
                                t.maxH))),
            ...
            viewMode === "halls" && halls.map(hall => {
                const hc = Object.entries(scheds).flatMap(([sp, ls]) => Object.entries(ls || {}).flatMap(([lv, lvGroups]) => Object.entries(lvGroups || {}).flatMap(([gid, cells]) => cells.filter(c => c.hallId === hall.id).map(c => (Object.assign(Object.assign({}, c), { spec: sp, level: +lv, gid }))))));
                if (!hc.length)
                    return null;
                return (React.createElement("div", { key: hall.id, style: { background: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: 13, padding: 14, marginBottom: 14 } },
                    React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 9, marginBottom: 10 } },
                        React.createElement("div", { style: { color: "#042F2E", fontWeight: 700, fontSize: 14 } }, hall.name),
                        React.createElement(Badge, { color: hall.type === "theory" ? "#0891B2" : "#10B981" }, hall.type === "theory" ? "نظري" : "عملي"),
                        React.createElement(Badge, { color: "#F59E0B" },
                            "\u0633\u0639\u0629: ",
                            hall.cap),
                        React.createElement(Badge, { color: "#0F766E" },
                            hc.length,
                            " \u062D\u0635\u0629")),
                    React.createElement(GridTable, { cells: hc, color: "#0D9488" })));
            })));
    };
    // ── SHARING MODAL ─────────────────────────────────────────
    // ── QUOTA TAB ─────────────────────────────────────────────
    const QuotaTab = () => {
        ...
        return (React.createElement("div", null,
            React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 18, flexWrap: "wrap", gap: 10 } },
                React.createElement("h2", { style: { color: "#042F2E", margin: 0, fontSize: 18 } }, "\uD83D\uDCCB \u0627\u0644\u0646\u0635\u0627\u0628 \u0627\u0644\u062A\u062F\u0631\u064A\u0628\u064A"),
                React.createElement("div", { style: { display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" } },
                    React.createElement("button", { onClick: () => setModal("importQuota"), style: { padding: "8px 16px", borderRadius: 10, border: "1px solid #0E7490",
                    ...
                    React.createElement("div", { style: { display: "flex", gap: 10 } },
                        React.createElement("div", { style: { background: "#E0FDF9", border: "1px solid #A5F3FC", borderRadius: 10, padding: "8px 16px", textAlign: "center" } },
                            React.createElement("div", { style: { color: "#0F766E", fontSize: 10 } }, "\u0627\u0644\u0646\u0638\u0631\u064A / \u0634\u0639\u0628\u0629"),
                            React.createElement("div", { style: { color: "#0E7490", fontWeight: 800, fontSize: 18 } },
                                THEORY_SIZE,
                                " \u0645\u062A\u062F\u0631\u0628")),
                        React.createElement("div", { style: { background: "#ECFDF5", border: "1px solid #6EE7B7", borderRadius: 10, padding: "8px 16px", textAlign: "center" } },
                            React.createElement("div", { style: { color: "#0F766E", fontSize: 10 } }, "\u0627\u0644\u0639\u0645\u0644\u064A / \u0634\u0639\u0628\u0629"),
            ...
            modal === "importQuota" && (React.createElement("div", { style: { position: "fixed", inset: 0, background: "#00000099", zIndex: 4000,
                    display: "flex", alignItems: "center", justifyContent: "center" } },
                React.createElement("div", { style: { background: "#FFFFFF", borderRadius: 18, padding: 24, width: 520,
                        maxHeight: "90vh", overflow: "auto", direction: "rtl", boxShadow: "0 20px 60px #00000033" } },
                    React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 18 } },
                        React.createElement("h3", { style: { color: "#042F2E", margin: 0, fontSize: 16, fontWeight: 800 } }, "\uD83D\uDCCA \u0627\u0633\u062A\u064A\u0631\u0627\u062F \u0639\u062F\u062F \u0627\u0644\u0645\u062A\u062F\u0631\u0628\u064A\u0646 \u0645\u0646 Excel"),
                        React.createElement("button", { onClick: () => { setModal(null); setImportTxt(""); }, style: { background: "none", border: "none", color: "#0C4A6E", cursor: "pointer", fontSize: 22 } }, "\u00D7")),
                    React.createElement("div", { style: { background: "#E0FDF9", border: "1px solid #A5F3FC", borderRadius: 10,
                    ...
                    React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 14 } },
                        React.createElement("div", null,
                            React.createElement("label", { style: { display: "block", color: "#0C4A6E", fontSize: 12, fontWeight: 700, marginBottom: 4 } }, "\u0639\u0645\u0648\u062F \u0631\u0645\u0632 \u0627\u0644\u0645\u0642\u0631\u0631 (Code)"),
                            React.createElement("select", { id: "quota-code-col", defaultValue: "0", style: { width: "100%", border: "1px solid #A5F3FC", borderRadius: 8, padding: "8px 10px",
                                    fontSize: 12, color: "#042F2E", background: "#F0FDFA" } }, ["العمود الأول", "العمود الثاني", "العمود الثالث", "العمود الرابع", "العمود الخامس"].map((l, i) => (React.createElement("option", { key: i, value: i }, l))))),
                        React.createElement("div", null,
                            React.createElement("label", { style: { display: "block", color: "#0C4A6E", fontSize: 12, fontWeight: 700, marginBottom: 4 } }, "\u0639\u0645\u0648\u062F \u0639\u062F\u062F \u0627\u0644\u0645\u062A\u062F\u0631\u0628\u064A\u0646"),
                            React.createElement("select", { id: "quota-count-col", defaultValue: "1", style: { width: "100%", border: "1px solid #A5F3FC", borderRadius: 8, padding: "8px 10px",
                                    fontSize: 12, color: "#042F2E", background: "#F0FDFA" } }, ["العمود الأول", "العمود الثاني", "العمود الثالث", "العمود الرابع", "العمود الخامس"].map((l, i) => (React.createElement("option", { key: i, value: i }, l)))))),
                    React.createElement("div", { style: { marginBottom: 14 } },
                        React.createElement("label", { style: { display: "block", color: "#0C4A6E", fontSize: 12, fontWeight: 700, marginBottom: 4 } }, "\u0641\u0627\u0635\u0644 \u0627\u0644\u0623\u0639\u0645\u062F\u0629"),
                        React.createElement("div", { style: { display: "flex", gap: 8 } }, [{ v: "tab", l: "Tab (افتراضي Excel)" },
                            ...
                            sep.l))))),
                    React.createElement("div", { style: { marginBottom: 14 } },
                        React.createElement("label", { style: { display: "block", color: "#0C4A6E", fontSize: 12, fontWeight: 700, marginBottom: 4 } }, "\u0627\u0644\u0635\u0642 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0647\u0646\u0627 (Ctrl+V):"),
                    ...
                    React.createElement("div", { style: { display: "flex", gap: 10 } },
                        ...
                        React.createElement("button", { onClick: () => { setModal(null); }, style: { padding: "12px 18px", background: "#F0FDFA", color: "#0C4A6E",
                                border: "1px solid #A5F3FC", borderRadius: 10, cursor: "pointer", fontSize: 13, fontWeight: 700 } }, "\u0625\u0644\u063A\u0627\u0621"))))),
            sections.map(sec => {
                ...
                return (React.createElement("div", { key: sec.spec, style: { marginBottom: 24 } },
                    ...
                    byLevel.map(({ lv, list }) => (React.createElement("div", { key: lv, style: { marginBottom: 14 } },
                        React.createElement("div", { style: { color: "#0F766E", fontSize: 11, fontWeight: 700, marginBottom: 6,
                        ...
                        React.createElement("div", { style: { overflowX: "auto" } },
                            React.createElement("table", { style: { borderCollapse: "collapse", width: "100%", fontSize: 12 } },
                                React.createElement("thead", null,
                                    React.createElement("tr", { style: { background: "#F0FDFA" } }, ["الرمز", "اسم المقرر", "مح", "عم", "س.أ", "عدد المتدربين", "شعب نظري", "شعب عملي", "إجمالي الشعب", "إجمالي ساعات الاتصال"].map(h => (React.createElement("th", { key: h, style: { color: "#0C4A6E", padding: "8px 10px",
                                ...
                                React.createElement("tbody", null,
                                    list.map(c => {
                                        ...
                                        return (React.createElement("tr", { key: c.id, style: { background: isGen ? "#FAFAF9" : "#FFFFFF" } },
                                            ...
                                            React.createElement("td", { style: { padding: "7px 10px", border: "1px solid #E2E8F0", color: "#134E4A" } }, c.name),
                                            React.createElement("td", { style: { padding: "7px 10px", border: "1px solid #E2E8F0", textAlign: "center" } }, theoryH > 0 ? React.createElement(Badge, { color: "#0891B2" },
                                                theoryH,
                                                "\u0633") : React.createElement("span", { style: { color: "#0C4A6E" } }, "\u2014")),
                                            ...
                                            React.createElement("td", { style: { padding: "5px 8px", border: "1px solid #E2E8F0", textAlign: "center" } },
                                                React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6, justifyContent: "center" } },
                                                    React.createElement("input", { type: "number", min: 0, defaultValue: quotaCounts[c.id] || "", key: c.id, onBlur: e => {
                                                        ...
                                                        }, placeholder: "0", style: { width: 80, background: count > 0 ? "#F0FDF4" : "#F0FDFA",
                                                    ...
                                                    React.createElement("span", { style: { color: "#0F766E", fontSize: 10 } }, "\u0645\u062A\u062F\u0631\u0628"))),
                                            React.createElement("td", { style: { padding: "7px 10px", border: "1px solid #E2E8F0", textAlign: "center" } }, theoryH > 0 && count > 0 ? (React.createElement("div", null,
                                                React.createElement(GroupBadge, { n: thGroups, color: "#0891B2" }),
                                                React.createElement("div", { style: { color: "#0F766E", fontSize: 9, marginTop: 2 } },
                                                    count,
                                                    " \u00F7 ",
                                                    THEORY_SIZE,
                                                    " = ",
                                                    thGroups))) : React.createElement("span", { style: { color: "#0C4A6E", fontSize: 11 } }, "\u2014")),
                                            React.createElement("td", { style: { padding: "7px 10px", border: "1px solid #E2E8F0", textAlign: "center" } }, practH > 0 && count > 0 ? (React.createElement("div", null,
                                                ...
                                                React.createElement("div", { style: { color: "#0F766E", fontSize: 9, marginTop: 2 } },
                                                    ...
                                                    PRACT_SIZE,
                                                    " = ",
                                                    prGroups))) : React.createElement("span", { style: { color: "#0C4A6E", fontSize: 11 } }, "\u2014")),
                                            React.createElement("td", { style: { padding: "7px 10px", border: "1px solid #E2E8F0", textAlign: "center" } }, total > 0 ? (React.createElement("span", { style: { background: cColor, color: "#fff", borderRadius: 7,
                                                    padding: "3px 10px", fontWeight: 800, fontSize: 13 } }, total)) : React.createElement("span", { style: { color: "#0C4A6E" } }, "\u2014")),
                                            (() => {
                                                ...
                                                return (React.createElement("td", { style: { padding: "7px 10px", border: "1px solid #E2E8F0", textAlign: "center",
                                                    ...
                                                    React.createElement("span", { style: { background: "#F97316", color: "#fff", borderRadius: 7,
                                                            padding: "3px 10px", fontWeight: 800, fontSize: 13 } },
                                                        totalCTH,
                                                        "\u0633"),
                                                    total > 0 && (React.createElement("div", { style: { color: "#0F766E", fontSize: 9, marginTop: 2 } },
                                                        thGroups > 0 ? `${thGroups}×${theoryH}` : "",
                                                        thGroups > 0 && prGroups > 0 ? " + " : "",
                                                        prGroups > 0 ? `${prGroups}×${practH}` : "")))) : React.createElement("span", { style: { color: "#0C4A6E" } }, "\u2014")));
                                            })()));
                                    }),
                                    (() => {
                                        ...
                                        return (React.createElement("tr", { style: { background: "#F0F9FF" } },
                                            ...
                                            React.createElement("td", { style: { padding: "6px 10px", border: "1px solid #E2E8F0", textAlign: "center" } },
                                                React.createElement(Badge, { color: "#10B981" },
                                                    ...
                                                    " \u0634\u0639\u0628\u0629")),
                                            React.createElement("td", { style: { padding: "6px 10px", border: "1px solid #E2E8F0", textAlign: "center" } },
                                                React.createElement("span", { style: { background: "#0E7490", color: "#fff", borderRadius: 7,
            ...
            (totalTheoryGroups + totalPractGroups) > 0 && (() => {
                ...
                return (React.createElement("div", { style: { background: "linear-gradient(135deg,#1E3A5F,#1D4ED8)", borderRadius: 14, padding: 20, marginTop: 8 } },
                    ...
                    React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 12 } },
                        React.createElement("div", { style: { background: "#ffffff18", borderRadius: 10, padding: "12px", textAlign: "center" } },
                            React.createElement("div", { style: { color: "#0C4A6E", fontSize: 10 } }, "\u0625\u062C\u0645\u0627\u0644\u064A \u0634\u0639\u0628 \u0627\u0644\u0646\u0638\u0631\u064A"),
                            React.createElement("div", { style: { color: "#CFFAFE", fontWeight: 900, fontSize: 24 } }, totalTheoryGroups),
                            React.createElement("div", { style: { color: "#0F766E", fontSize: 9 } },
                                "\u00D7 ",
                                THEORY_SIZE,
                                " \u0645\u062A\u062F\u0631\u0628/\u0634\u0639\u0628\u0629")),
                        React.createElement("div", { style: { background: "#ffffff18", borderRadius: 10, padding: "12px", textAlign: "center" } },
                            ...
                            React.createElement("div", { style: { color: "#6EE7B7", fontSize: 9 } },
                                ...
                                PRACT_SIZE,
                                " \u0645\u062A\u062F\u0631\u0628\u0627\u064B/\u0634\u0639\u0628\u0629")),
                        React.createElement("div", { style: { background: "#ffffff28", borderRadius: 10, padding: "12px", textAlign: "center", border: "1px solid #ffffff33" } },
                        ...
                        React.createElement("div", { style: { background: "#ffffff28", borderRadius: 10, padding: "12px", textAlign: "center", border: "2px solid #FB923C" } },
            ...
            Object.values(quotaCounts).some(v => v > 0) && (() => {
                ...
                return (React.createElement("div", { style: { marginTop: 20 } },
                    React.createElement("h3", { style: { color: "#042F2E", fontSize: 14, fontWeight: 800, marginBottom: 14,
                    ...
                    React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 } }, specData.map((item) => {
                        ...
                        return (React.createElement("div", { key: specId, style: { background: "#FFFFFF", border: `2px solid ${sc}33`,
                            ...
                            React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginBottom: 10 } },
                                React.createElement("div", { style: { background: "#E0FDF9", borderRadius: 8, padding: "8px", textAlign: "center" } },
                                    React.createElement("div", { style: { color: "#0F766E", fontSize: 9 } }, "\u0633\u0627\u0639\u0627\u062A \u0627\u0644\u0646\u0638\u0631\u064A"),
                                    React.createElement("div", { style: { color: "#0E7490", fontWeight: 800, fontSize: 16 } }, theoryCTH),
                                    React.createElement("div", { style: { color: "#0C4A6E", fontSize: 8 } }, "\u0633/\u0623\u0633\u0628\u0648\u0639")),
                                React.createElement("div", { style: { background: "#ECFDF5", borderRadius: 8, padding: "8px", textAlign: "center" } },
                                    React.createElement("div", { style: { color: "#0F766E", fontSize: 9 } }, "\u0633\u0627\u0639\u0627\u062A \u0627\u0644\u0639\u0645\u0644\u064A"),
                                    React.createElement("div", { style: { color: "#065F46", fontWeight: 800, fontSize: 16 } }, practCTH),
                                    React.createElement("div", { style: { color: "#0C4A6E", fontSize: 8 } }, "\u0633/\u0623\u0633\u0628\u0648\u0639")),
                                React.createElement("div", { style: { background: `${sc}11`, borderRadius: 8, padding: "8px", textAlign: "center",
                                        border: `1px solid ${sc}33` } },
                                    React.createElement("div", { style: { color: "#0F766E", fontSize: 9 } }, "\u0627\u0644\u0625\u062C\u0645\u0627\u0644\u064A"),
                                    React.createElement("div", { style: { color: sc, fontWeight: 900, fontSize: 18 } }, specCTH),
                                    React.createElement("div", { style: { color: "#0C4A6E", fontSize: 8 } }, "\u0633/\u0623\u0633\u0628\u0648\u0639"))),
                            genCTH > 0 && (React.createElement("div", { style: { background: "#F5F3FF", border: "1px solid #DDD6FE", borderRadius: 8,
                            ...
                            React.createElement("div", { style: { marginBottom: 10 } },
                                React.createElement("div", { style: { color: "#0C4A6E", fontSize: 11, fontWeight: 700, marginBottom: 8 } }, "\u062A\u0648\u0632\u064A\u0639 \u0639\u0644\u0649 \u0627\u0644\u0645\u062F\u0631\u0628\u064A\u0646 \u0627\u0644\u0645\u0624\u0647\u0644\u064A\u0646:"),
                                allEligible.map(t => {
                                    ...
                                    return (React.createElement("div", { key: t.id, style: { marginBottom: 8 } },
                                        React.createElement("div", { style: { display: "flex", justifyContent: "space-between",
                                            ...
                                            React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6 } },
                                                React.createElement("span", { style: { color: "#134E4A", fontSize: 11, fontWeight: 600 } }, t.name),
                                            ...
                                            React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6 } },
                                                React.createElement("span", { style: { color: over ? "#EF4444" : "#0F766E",
                                                        fontSize: 11, fontWeight: 700 } },
                                                    "~",
                                                    actualCTH,
                                                    "\u0633"),
                                                React.createElement("span", { style: { color: "#0C4A6E", fontSize: 10 } },
                                                    "/ ",
                                                    t.maxH,
                                                    "\u0633"),
                                        ...
                                        React.createElement("div", { style: { background: "#99F6E4", borderRadius: 99, height: 6, overflow: "hidden" } },
                            ...
                            React.createElement("div", { style: { background: overloaded ? "#FEF2F2" : "#F0FDF4",
                                    ...
                                    borderRadius: 8, padding: "8px 12px", fontSize: 11 } }, overloaded ? (React.createElement("div", { style: { color: "#991B1B" } },
    ...
    return (React.createElement("div", { style: { minHeight: "100vh", background: "#F0FDFA", fontFamily: "'Segoe UI',Tahoma,Arial,sans-serif", direction: "rtl", paddingBottom: 100 } },
        !entered && (React.createElement("div", { style: { minHeight: "100vh", background: "linear-gradient(180deg,#0C4A6E 0%,#0E7490 50%,#0891B2 100%)",
                display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center",
                padding: "20px 20px", direction: "rtl" } },
            React.createElement("div", { style: { background: "#FFFFFF", borderRadius: 20, padding: "24px 32px",
                    marginBottom: 20, boxShadow: "0 12px 40px #00000044", width: "100%", maxWidth: 400, textAlign: "center" } },
                React.createElement("img", { src: LOGO_B64, alt: "TVTC", style: { width: "100%", maxWidth: 360, height: "auto", objectFit: "contain" } })),
            React.createElement("div", { style: { textAlign: "center", marginBottom: 20 } },
                React.createElement("div", { style: { color: "#FFFFFF", fontSize: 22, fontWeight: 900, marginBottom: 4,
                        textShadow: "0 2px 8px #00000044" } }, "\u0646\u0638\u0627\u0645 \u0627\u0644\u062C\u062F\u0627\u0648\u0644 \u0627\u0644\u062A\u062F\u0631\u064A\u0628\u064A\u0629"),
                React.createElement("div", { style: { color: "#BAE6FD", fontSize: 13, fontWeight: 500 } }, "\u0625\u0639\u062F\u0627\u062F \u0648\u0625\u062F\u0627\u0631\u0629 \u0627\u0644\u062C\u062F\u0627\u0648\u0644 \u2014 \u0648\u0643\u0627\u0644\u0629 \u0634\u0624\u0648\u0646 \u0627\u0644\u0645\u062F\u0631\u0628\u064A\u0646")),
            React.createElement("div", { style: { background: "#FFFFFF", borderRadius: 20, padding: "24px 20px",
                    width: "100%", maxWidth: 400, boxShadow: "0 12px 40px #00000044" } },
                React.createElement("div", { style: { marginBottom: 16 } },
                    React.createElement("label", { style: { display: "block", color: "#0C4A6E", fontSize: 14, fontWeight: 800, marginBottom: 8 } }, "\uD83C\uDFEB \u0627\u0633\u0645 \u0627\u0644\u0643\u0644\u064A\u0629"),
                    React.createElement("input", { type: "text", value: collegeName, onChange: e => setCollegeName(e.target.value), onKeyDown: e => {
                            if (e.key === "Enter" && collegeName.trim()) {
                                logEntry(collegeName.trim());
                                setEntered(true);
                            }
                        }, placeholder: "\u0627\u0644\u0643\u0644\u064A\u0629 \u0627\u0644\u062A\u0642\u0646\u064A\u0629 \u0628\u0627\u0644\u0628\u062F\u0627\u0626\u0639", style: { width: "100%", border: `2px solid ${collegeName ? "#0E7490" : "#0D9488"}`,
                ...
                React.createElement("button", { onClick: () => {
                    ...
                    }, disabled: !collegeName.trim(), style: { width: "100%", padding: "15px", borderRadius: 12, border: "none",
                        ...
                        transition: "all 0.2s", letterSpacing: 0.5 } }, "\u062F\u062E\u0648\u0644 \u0627\u0644\u0646\u0638\u0627\u0645 \u2190"),
                ...
                ].map(s => (React.createElement("div", { key: s.l, style: { background: s.c + "15", border: `1.5px solid ${s.c}55`,
                        borderRadius: 10, padding: "10px 6px", textAlign: "center" } },
                    React.createElement("div", { style: { color: s.c, fontWeight: 900, fontSize: 22 } }, s.v),
                    React.createElement("div", { style: { color: "#0C4A6E", fontSize: 11, fontWeight: 600 } }, s.l)))))),
            React.createElement("div", { style: { marginTop: 18, textAlign: "center" } },
                React.createElement("div", { style: { color: "#BAE6FD", fontSize: 11, fontWeight: 600 } }, "\u062A\u0635\u0645\u064A\u0645 \u0648\u062A\u0637\u0648\u064A\u0631: \u0645. \u0645\u0639\u0627\u0630 \u0639\u0628\u062F\u0627\u0644\u0644\u0647 \u0627\u0644\u0633\u0644\u0648\u0645"),
                React.createElement("div", { style: { color: "#7DD3FC", fontSize: 10, marginTop: 2 } }, "\u0648\u0643\u064A\u0644 \u0634\u0624\u0648\u0646 \u0627\u0644\u0645\u062F\u0631\u0628\u064A\u0646 \u2014 \u0627\u0644\u0643\u0644\u064A\u0629 \u0627\u0644\u062A\u0642\u0646\u064A\u0629 \u0628\u0627\u0644\u0628\u062F\u0627\u0626\u0639"),
                React.createElement("button", { onClick: () => {
                        ...
                        color: "#7DD3FC", borderRadius: 8, padding: "6px 16px", cursor: "pointer", fontSize: 10 } }, "\uD83D\uDD10 \u0644\u0648\u062D\u0629 \u0627\u0644\u0645\u0634\u0631\u0641")))),
        adminView && !entered && (React.createElement("div", { style: { minHeight: "100vh", background: "#0C4A6E", direction: "rtl", padding: 20 } },
            React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 } },
                React.createElement("h2", { style: { color: "#FFFFFF", margin: 0, fontSize: 18, fontWeight: 800 } }, "\uD83D\uDD10 \u0644\u0648\u062D\u0629 \u0627\u0644\u0645\u0634\u0631\u0641"),
                React.createElement("button", { onClick: () => setAdminView(false), style: { background: "#ffffff22", border: "none", color: "#A5F3FC",
                        borderRadius: 8, padding: "8px 16px", cursor: "pointer", fontSize: 13 } }, "\u2190 \u0631\u062C\u0648\u0639")),
            React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: 12, marginBottom: 20 } },
                React.createElement("div", { style: { background: "#ffffff15", borderRadius: 14, padding: 16, textAlign: "center" } },
                    React.createElement("div", { style: { color: "#A5F3FC", fontSize: 11 } }, "\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u062C\u0644\u0633\u0627\u062A"),
                    React.createElement("div", { style: { color: "#FFFFFF", fontWeight: 900, fontSize: 32 } }, users.length)),
                React.createElement("div", { style: { background: "#ffffff15", borderRadius: 14, padding: 16, textAlign: "center" } },
                    React.createElement("div", { style: { color: "#A5F3FC", fontSize: 11 } }, "\u0643\u0644\u064A\u0627\u062A \u0645\u062E\u062A\u0644\u0641\u0629"),
                    React.createElement("div", { style: { color: "#FFFFFF", fontWeight: 900, fontSize: 32 } }, new Set(users.map(u => u.college)).size))),
            (() => {
                const collegeCounts = users.reduce((acc, u) => {
                    acc[u.college] = (acc[u.college] || 0) + 1;
                    return acc;
                }, {});
                return (React.createElement("div", { style: { background: "#ffffff10", borderRadius: 14, padding: 16, marginBottom: 16 } },
                    React.createElement("div", { style: { color: "#A5F3FC", fontWeight: 700, marginBottom: 12 } }, "\u0627\u0644\u0643\u0644\u064A\u0627\u062A \u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0650\u0645\u0629"),
                    Object.entries(collegeCounts).sort((a, b) => b[1] - a[1]).map(([col, cnt]) => (React.createElement("div", { key: col, style: { display: "flex", justifyContent: "space-between",
                            alignItems: "center", marginBottom: 8, padding: "8px 12px",
                            background: "#ffffff10", borderRadius: 8 } },
                        React.createElement("span", { style: { color: "#FFFFFF", fontSize: 13 } }, col),
                        React.createElement("span", { style: { background: "#0E7490", color: "#fff", borderRadius: 20,
                                padding: "2px 10px", fontSize: 11, fontWeight: 700 } },
                            cnt,
                            " ",
                            cnt === 1 ? "جلسة" : "جلسات")))),
                    Object.keys(collegeCounts).length === 0 && (React.createElement("div", { style: { color: "#7DD3FC", fontSize: 12, textAlign: "center" } }, "\u0644\u0627 \u062A\u0648\u062C\u062F \u062C\u0644\u0633\u0627\u062A \u0645\u0633\u062C\u0644\u0629 \u0628\u0639\u062F"))));
            })(),
            React.createElement("div", { style: { background: "#ffffff10", borderRadius: 14, padding: 16 } },
                React.createElement("div", { style: { color: "#A5F3FC", fontWeight: 700, marginBottom: 12 } },
                    "\u0622\u062E\u0631 \u0627\u0644\u062C\u0644\u0633\u0627\u062A (",
                    users.length,
                    ")"),
                React.createElement("div", { style: { maxHeight: 400, overflowY: "auto" } },
                    users.slice(0, 50).map((u, i) => (React.createElement("div", { key: i, style: { display: "flex", justifyContent: "space-between",
                            alignItems: "center", padding: "10px 12px", marginBottom: 6,
                            background: "#ffffff10", borderRadius: 10,
                            borderRight: `3px solid #0E7490` } },
                        React.createElement("div", null,
                            React.createElement("div", { style: { color: "#FFFFFF", fontSize: 13, fontWeight: 600 } }, u.college),
                            React.createElement("div", { style: { color: "#7DD3FC", fontSize: 10 } },
                                u.date,
                                " \u2014 ",
                                u.timeStr)),
                        React.createElement("span", { style: { color: "#A5F3FC", fontSize: 10 } },
                            "#",
                            i + 1)))),
                    users.length === 0 && (React.createElement("div", { style: { color: "#7DD3FC", fontSize: 12, textAlign: "center", padding: 20 } }, "\u0644\u0627 \u062A\u0648\u062C\u062F \u062C\u0644\u0633\u0627\u062A \u0645\u0633\u062C\u0644\u0629")))),
            React.createElement("button", { onClick: async () => {
                    if (window.confirm("هل تريد حذف جميع السجلات؟")) {
                        try {
                            const r = await window.storage.list("session-", true);
                            for (const k of ((r === null || r === void 0 ? void 0 : r.keys) || []))
                    ...
                    cursor: "pointer", fontSize: 13, fontWeight: 700 } }, "\uD83D\uDDD1\uFE0F \u062D\u0630\u0641 \u062C\u0645\u064A\u0639 \u0627\u0644\u0633\u062C\u0644\u0627\u062A"))),
        entered && (React.createElement(React.Fragment, null,
      ...
      ` } }),
            React.createElement("div", { style: { background: "linear-gradient(135deg,#0C4A6E,#0E7490)", padding: "10px 16px",
                ...
                React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10 } },
                    ...
                    React.createElement("div", { style: { borderRight: "1px solid #ffffff33", paddingRight: 10 } },
                        ...
                        React.createElement("div", { style: { color: "#0C4A6E", fontSize: 10, lineHeight: 1.3, fontWeight: 600 } }, collegeName),
                        React.createElement("div", { style: { color: "#0C4A6E", fontSize: 8, direction: "ltr", lineHeight: 1.2 } }, "07:30\u201314:20 | 8 \u062D\u0635\u0635 | 50 \u062F\u0642\u064A\u0642\u0629"))),
                React.createElement("div", { style: { display: "flex", gap: 8 } },
                    React.createElement("button", { onClick: doBackup, title: "\u0646\u0633\u062E \u0627\u062D\u062A\u064A\u0627\u0637\u064A", style: { width: 38, height: 38, borderRadius: 10, border: "1px solid #10b98166",
                            background: "#10b98120", color: "#10b981", cursor: "pointer", fontSize: 18,
                            display: "flex", alignItems: "center", justifyContent: "center" } }, "\uD83D\uDCBE"),
                    React.createElement("button", { onClick: () => setModal("restore"), title: "\u0627\u0633\u062A\u0639\u0627\u062F\u0629", style: { width: 38, height: 38, borderRadius: 10, border: "1px solid #f59e0b66",
            ...
            React.createElement("div", { style: { background: "#FFFFFF", borderBottom: "2px solid #E2E8F0",
                ...
                React.createElement("span", { style: { color: "#042F2E", fontWeight: 800, fontSize: 16 } }, (_b = TAB_ICONS[tab]) === null || _b === void 0 ? void 0 : _b.label)),
            ...
            React.createElement("div", { style: { position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 400,
                ...
                React.createElement("div", { style: { display: "flex", alignItems: "stretch" } }, TABS.map(t => {
                    var _a, _b;
                    ...
                    return (React.createElement("button", { key: t.id, onClick: () => setTab(t.id), style: { flex: 1, display: "flex", flexDirection: "column", alignItems: "center",
                        ...
                        React.createElement("span", { style: { fontSize: 20, lineHeight: 1, marginBottom: 3 } }, (_a = TAB_ICONS[t.id]) === null || _a === void 0 ? void 0 : _a.icon),
                        React.createElement("span", { style: { fontSize: 9, fontWeight: active ? 700 : 500,
                                color: active ? "#0E7490" : "#0F766E", lineHeight: 1, whiteSpace: "nowrap" } }, (_b = TAB_ICONS[t.id]) === null || _b === void 0 ? void 0 : _b.label)));
                })),
            ...
            modal === "restore" && (React.createElement("div", { style: { position: "fixed", inset: 0, background: "#000000bb", zIndex: 3000, display: "flex", alignItems: "center", justifyContent: "center" } },
                React.createElement("div", { style: { background: "#FFFFFF", border: "1px solid #1e2d45", borderRadius: 16, padding: 26, width: 520, direction: "rtl" } },
                    React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 18 } },
                        React.createElement("h3", { style: { color: "#042F2E", margin: 0, fontSize: 16 } }, "\uD83D\uDCC2 \u0627\u0633\u062A\u0639\u0627\u062F\u0629 \u0646\u0633\u062E\u0629 \u0627\u062D\u062A\u064A\u0627\u0637\u064A\u0629"),
                        React.createElement("button", { onClick: () => setModal(null), style: { background: "none", border: "none", color: "#0F766E", cursor: "pointer", fontSize: 22 } }, "\u00D7")),
                    React.createElement("div", { style: { color: "#0F766E", fontSize: 12, marginBottom: 14, lineHeight: 1.8 } }, "\u0627\u0644\u0635\u0642 \u0645\u062D\u062A\u0648\u0649 \u0645\u0644\u0641 \u0627\u0644\u0646\u0633\u062E\u0629 \u0627\u0644\u0627\u062D\u062A\u064A\u0627\u0637\u064A\u0629 (.json) \u0647\u0646\u0627\u060C \u0623\u0648 \u0627\u0633\u062D\u0628 \u0627\u0644\u0645\u0644\u0641 \u0648\u0623\u0641\u0644\u062A\u0647 \u0641\u064A \u0627\u0644\u0645\u0631\u0628\u0639 \u0623\u062F\u0646\u0627\u0647."),
                    React.createElement("textarea", { id: "restore-input", rows: 8, placeholder: '{ "version": "1.0", "courses": [...], ... }', style: { width: "100%", background: "#FFFFFF", border: "1px solid #1e3a5f", borderRadius: 8,
                            padding: 12, color: "#134E4A", fontSize: 12, fontFamily: "monospace", boxSizing: "border-box", direction: "ltr", resize: "vertical" }, onDragOver: e => e.preventDefault(), onDrop: e => {
                            e.preventDefault();
                    ...
                    React.createElement("div", { style: { display: "flex", gap: 10, marginTop: 14 } },
                        ...
                        React.createElement("button", { onClick: () => setModal(null), style: { flex: 1, background: "transparent", color: "#0F766E",
                                border: "1px solid #334155", borderRadius: 9, padding: "10px", cursor: "pointer", fontSize: 13 } }, "\u0625\u0644\u063A\u0627\u0621"))))))) /* end entered */));
}
